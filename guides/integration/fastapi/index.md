# [Using fyn with FastAPI](#using-fyn-with-fastapi)

[FastAPI](https://github.com/fastapi/fastapi) is a modern, high-performance Python web framework. You can use fyn to manage your FastAPI project, including installing dependencies, managing environments, running FastAPI applications, and more.
...
`fyn run` will automatically resolve and lock the project dependencies (i.e., create a `fyn.lock` alongside the `pyproject.toml`), create a virtual environment, and run the command in that environment.
...
For more on using fyn with Docker, see the [Docker guide](../docker/).
