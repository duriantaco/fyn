# [Using fyn with marimo](#using-fyn-with-marimo)
...
Because marimo notebooks are stored as Python scripts, they can encapsulate their own dependencies using inline script metadata, via fyn's [support for scripts](../../scripts/). For example, to add `numpy` as a dependency to your notebook, use this command:
