...
Requirements:
    ...
    $ fyn pip install -r scripts/scenarios/pylock.toml
...
Usage:
    ...
    Scenarios can be developed locally with the following workflow:
        ...
        Override the fyn package index and update the tests
...
TESTS = PROJECT_ROOT / "crates" / "fyn" / "tests" / "it"
TESTS_COMMON_MOD_RS = PROJECT_ROOT / "crates" / "fyn-test" / "src" / "lib.rs"
