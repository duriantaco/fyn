...
vendored files into `crates/fyn-python/python/packaging`, applies all
`*.patch` files in that directory, and regenerates the README.

Example:
    fyn run ./scripts/vendor-packaging.py cc938f984bbbe43c5734b9656c9837ab3a28191f
"""
...
PACKAGING_DIR = REPO_ROOT / "crates" / "fyn-python" / "python" / "packaging"
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="fyn-vendor-packaging-") as temp_dir:
