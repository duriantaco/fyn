...
use fv_fs::link::{CopyLocks, LinkOptions, OnExistingDirectory, link_dir};
use fv_preview::{Preview, PreviewFeature};
use fv_warnings::warn_user;

use crate::Error;

pub use fv_fs::link::LinkMode;
...
impl InstallState {
    ...
    /// Get the underlying copy locks for use with [`fv_fs::link::link_dir`] functions.
