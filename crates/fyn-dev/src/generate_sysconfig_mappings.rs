...
const TARGETS_YML_URL: &str = "https://raw.githubusercontent.com/astral-sh/python-build-standalone/refs/tags/20260408/cpython-unix/targets.yml";
...
async fn generate() -> Result<String> {
    ...
    output.push_str("//! Targets from <https://github.com/astral-sh/python-build-standalone/blob/20260408/cpython-unix/targets.yml>\n");
    output.push_str("//!\n");
