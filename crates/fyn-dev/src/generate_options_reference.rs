...
use fyn_options_metadata::{OptionField, OptionSet, OptionsMetadata, Visit};
use fyn_settings::Options as SettingsOptions;
use fyn_workspace::pyproject::Toolfyn as WorkspaceOptions;
...
// `description` in fyn.schema.json, see https://github.com/SchemaStore/schemastore/blob/master/editor-features.md#title-as-an-expected-object-type
/// Metadata and configuration for fyn.
...
fn emit_field(output: &mut String, name: &str, field: &OptionField, parents: &[Set]) {
    ...
    match parents[0] {
        ...
        Set::Global {
            ...
            // For uv_toml_only options, only show the fyn.toml tab
...
fn format_header(
    ...
    let tool_parent = match configuration {
        ConfigurationFile::PyprojectToml => Some("tool.fyn"),
