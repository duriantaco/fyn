//! Generate the environment variables reference from `fyn_static::EnvVars`.
...
fn generate() -> String {
    ...
    output.push_str("fyn defines and respects the following environment variables:\n\n");
    ...
    output.push_str("fyn also reads the following externally defined environment variables:\n\n");
