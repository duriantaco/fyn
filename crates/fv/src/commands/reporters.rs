...
use fv_python::PythonInstallationKey;
...
impl From<fv_python::downloads::Direction> for Direction {
    fn from(dir: fv_python::downloads::Direction) -> Self {
        match dir {
            fv_python::downloads::Direction::Download => Self::Download,
            fv_python::downloads::Direction::Extract => Self::Extract,
        }
    }
}
...
impl fv_installer::PrepareReporter for PrepareReporter {
...
impl fv_resolver::ResolverReporter for ResolverReporter {
...
impl fv_distribution::Reporter for ResolverReporter {
    fn on_build_start(&self, source: &BuildableSource) -> usize {
        self.reporter.on_build_start(source)
    }
...
impl fv_installer::InstallReporter for InstallReporter {
...
impl fv_python::downloads::Reporter for PythonDownloadReporter {
    fn on_request_start(
        &self,
        direction: fv_python::downloads::Direction,
    ...
    fn on_request_complete(&self, direction: fv_python::downloads::Direction, id: usize) {
...
impl fv_publish::Reporter for PublishReporter {
...
impl fv_cache::CleanReporter for CleaningDirectoryReporter {
    fn on_clean(&self) {
        self.bar.inc(1);
    }
...
impl fv_bin_install::Reporter for BinaryDownloadReporter {
