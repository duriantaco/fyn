...
fn cache_size_empty_raw() {
    ...
    fv_snapshot!(context.cache_size().arg("--preview"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    0
...
fn cache_size_with_packages_raw() {
    ...
    fv_snapshot!(context.with_filtered_cache_size().filters(), context.cache_size().arg("--preview"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    [SIZE]
...
fn cache_size_with_packages_human() {
    ...
    fv_snapshot!(context.with_filtered_cache_size().filters(), context.cache_size().arg("--preview").arg("--human"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    [SIZE]
