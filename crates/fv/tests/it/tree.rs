...
fn nested_dependencies() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.tree().arg("--universal"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    project v0.1.0
    ...
    // `fv tree` should update the lockfile
...
fn nested_platform_dependencies() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.tree().arg("--python-platform").arg("linux"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    project v0.1.0
...
fn invert() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.tree().arg("--invert"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    joblib v1.3.2
    ...
    fv_snapshot!(context.filters(), context.tree().arg("--invert").arg("--no-dedupe"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    joblib v1.3.2
...
fn frozen() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.tree().arg("--frozen"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    project v0.1.0
...
fn outdated() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.tree().arg("--outdated").arg("--universal"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    project v0.1.0
...
fn platform_dependencies() -> Result<()> {
    ...
    #[cfg(not(windows))]
    fv_snapshot!(context.filters(), context.tree(), @"
    success: true
    exit_code: 0
    ----- stdout -----
    project v0.1.0
    ...
    fv_snapshot!(context.filters(), context.tree().arg("--python-platform").arg("windows"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    project v0.1.0
...
fn platform_dependencies_inverted() -> Result<()> {
    ...
    // When `--universal` is _not_ provided, `colorama` should _not_ be included.
    fv_snapshot!(context.filters(), context.tree().arg("--invert").arg("--python-platform").arg("linux"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    click v8.1.7
    ...
    // Unless `--python-platform` is set to `windows`, in which case it should be included.
    fv_snapshot!(context.filters(), context.tree().arg("--invert").arg("--python-platform").arg("windows"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    colorama v0.4.6
...
fn dev_dependencies() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.tree().arg("--no-dev"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    project v0.1.0
...
fn dev_dependencies_inverted() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.tree().arg("--universal").arg("--invert"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    idna v3.6
    ...
    fv_snapshot!(context.filters(), context.tree().arg("--universal").arg("--invert").arg("--no-dev"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    iniconfig v2.0.0
...
fn package() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.tree().arg("--package").arg("scipy"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    scipy v1.12.0
    ...
    fv_snapshot!(context.filters(), context.tree().arg("--package").arg("numpy").arg("--invert"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    numpy v1.26.4
...
fn group() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.tree().arg("--only-group").arg("bar"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    project v0.1.0
    ...
    fv_snapshot!(context.filters(), context.tree().arg("--group").arg("foo"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    project v0.1.0
    ...
    fv_snapshot!(context.filters(), context.tree().arg("--group").arg("foo").arg("--group").arg("bar"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    project v0.1.0
    ...
    fv_snapshot!(context.filters(), context.tree().arg("--all-groups"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    project v0.1.0
    ...
    fv_snapshot!(context.filters(), context.tree().arg("--all-groups").arg("--no-group").arg("bar"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    project v0.1.0
...
fn cycle() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.tree().arg("--package").arg("traceback2").arg("--package").arg("six"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    six v1.16.0
    ...
    fv_snapshot!(context.filters(), context.tree().arg("--package").arg("traceback2").arg("--package").arg("six").arg("--invert"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    six v1.16.0
...
fn cycle_no_orphaned_roots() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.tree().arg("--universal").arg("--depth").arg("1"), @r###"
    success: true
    exit_code: 0
    ----- stdout -----
    project v0.1.0
...
fn cycle_no_infinite_loop() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.tree().arg("--universal").arg("--depth").arg("2"), @r###"
    success: true
    exit_code: 0
    ----- stdout -----
    project v0.1.0
...
fn cycle_invert() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.tree().arg("--universal").arg("--invert").arg("--depth").arg("1"), @r###"
    success: true
    exit_code: 0
    ----- stdout -----
    argparse v1.4.0
...
fn cycle_depth_boundary_no_premature_dedupe() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.tree().arg("--universal").arg("--depth").arg("3"), @r"
    success: true
    exit_code: 0
    ----- stdout -----
    project v0.1.0
...
fn cycle_invert_deep() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.tree().arg("--universal").arg("--invert").arg("--depth").arg("2"), @r"
    success: true
    exit_code: 0
    ----- stdout -----
    argparse v1.4.0
...
fn cycle_depth_no_dedupe() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.tree().arg("--universal").arg("--no-dedupe").arg("--depth").arg("2"), @r###"
    success: true
    exit_code: 0
    ----- stdout -----
    project v0.1.0
...
fn workspace_dev() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.tree().arg("--universal").arg("--no-dev"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    project v0.1.0
...
fn script() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.tree().arg("--script").arg(script.path()), @"
    success: true
    exit_code: 0
    ----- stdout -----
    rich v13.7.1
    ...
    fv_snapshot!(context.filters(), context.lock().arg("--script").arg(script.path()), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn only_group() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.tree().arg("--universal").arg("--only-group").arg("dev"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    project v0.1.0
    ...
    fv_snapshot!(context.filters(), context.tree().arg("--universal").arg("--only-group").arg("test"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    project v0.1.0
...
fn show_sizes() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.tree().arg("--show-sizes").arg("--universal"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    project v0.1.0
...
fn workspace_circular_dependencies() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.tree().arg("--package").arg("package-a"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    package-a v0.1.0
    ...
    fv_snapshot!(context.filters(), context.tree().arg("--package").arg("package-b"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    package-b v0.1.0
    ...
    fv_snapshot!(context.filters(), context.tree().arg("--package").arg("package-a").arg("--package").arg("package-b"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    package-a v0.1.0
