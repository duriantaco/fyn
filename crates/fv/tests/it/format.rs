...
fn format_project() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.format(), @"
    success: true
    exit_code: 0
    ----- stdout -----
    1 file reformatted
    ...
    ----- stderr -----
    warning: `fv format` is experimental and may change without warning. Pass `--preview-features format` to disable this warning.
    ");
...
fn format_from_project_root() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.format().current_dir(&subdir), @"
    success: true
    exit_code: 0
    ----- stdout -----
    1 file reformatted
...
fn format_no_project() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.format().arg("--no-project"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    1 file reformatted
...
fn format_relative_project() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.format().arg("--project").arg("project"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    1 file reformatted
...
fn format_check() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.format().arg("--check"), @"
    success: false
    exit_code: 1
    ----- stdout -----
...
fn format_diff() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.format().arg("--diff"), @"
    success: false
    exit_code: 1
    ----- stdout -----
    --- main.py
...
fn format_with_ruff_args() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.format().arg("--").arg("main.py").arg("--line-length").arg("200"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn format_specific_files() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.format().arg("--").arg("main.py"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    1 file reformatted
...
fn format_version_option() -> Result<()> {
    ...
    // format command :)
    fv_snapshot!(context.filters(), context.format().arg("--version").arg("0.8.2"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    1 file reformatted
...
fn format_version_constraints() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.format().arg("--version").arg(">=0.8.0").arg("--show-version"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    1 file reformatted
...
fn format_version_latest() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.format().arg("--version").arg("latest").arg("--show-version"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    1 file reformatted
...
fn format_exclude_newer() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.format().arg("--exclude-newer").arg("2026-01-01").arg("--version").arg("latest").arg("--show-version"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    1 file reformatted
...
fn format_no_matching_version() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.format().arg("--version").arg(">=999.0.0"), @"
    success: false
    exit_code: 2
    ----- stdout -----
