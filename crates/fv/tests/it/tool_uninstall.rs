...
fn tool_uninstall() {
    ...
    fv_snapshot!(context.filters(), context.tool_uninstall().arg("black")
        .env(EnvVars::UV_TOOL_DIR, tool_dir.as_os_str())
        .env(EnvVars::XDG_BIN_HOME, bin_dir.as_os_str()), @"
    success: true
    exit_code: 0
...
fn tool_uninstall_multiple_names() {
    ...
    fv_snapshot!(context.filters(), context.tool_uninstall().arg("black").arg("ruff")
        .env(EnvVars::UV_TOOL_DIR, tool_dir.as_os_str())
        .env(EnvVars::XDG_BIN_HOME, bin_dir.as_os_str()), @"
    success: true
    exit_code: 0
...
fn tool_uninstall_all_missing_receipt() {
    ...
    fv_snapshot!(context.filters(), context.tool_uninstall().arg("--all")
        .env(EnvVars::UV_TOOL_DIR, tool_dir.as_os_str())
        .env(EnvVars::XDG_BIN_HOME, bin_dir.as_os_str()), @"
    success: true
    exit_code: 0
