...
mod conditional_imports {
    pub(crate) use fv_test::{READ_ONLY_GITHUB_TOKEN, decode_token};
}
...
use fv_cache_key::{RepositoryUrl, cache_digest};
use fv_fs::Simplified;
use fv_static::EnvVars;

use fv_test::{fv_snapshot, packse_index_url, venv_bin_path};
...
fn add_registry() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("anyio==3.7.0"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_git() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("uv-public-pypackage @ git+https://github.com/astral-test/uv-public-pypackage@0.0.1"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.add().arg("uv-public-pypackage @ git+https://github.com/astral-test/uv-public-pypackage").arg("--tag=0.0.1"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_git_private_source() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg(format!("uv-private-pypackage @ git+https://{token}@github.com/astral-test/uv-private-pypackage")), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_git_private_raw() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg(format!("uv-private-pypackage @ git+https://{token}@github.com/astral-test/uv-private-pypackage")).arg("--raw-sources"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_git_error() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("flask").arg("--tag").arg("0.0.1"), @"
    success: false
    exit_code: 2
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.add().arg("flask @ https://files.pythonhosted.org/packages/61/80/ffe1da13ad9300f87c93af113edd0638c75138c42a0994becfacac078c06/flask-3.0.3-py3-none-any.whl").arg("--branch").arg("0.0.1"), @"
    success: false
    exit_code: 2
    ----- stdout -----
...
fn add_git_branch() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("uv-public-pypackage @ git+https://github.com/astral-test/uv-public-pypackage").arg("--branch").arg("test-branch"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_git_lfs() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add()
        .arg("--no-cache")
    ...
    // They help handle slightly different output in fv-distribution/src/source/mod.rs between
...
fn add_git_raw() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("uv-public-pypackage @ git+https://github.com/astral-test/uv-public-pypackage@0.0.1").arg("--raw-sources"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_git_implicit() -> Result<()> {
    ...
    // Omit the `git+` prefix.
    fv_snapshot!(context.filters(), context.add().arg("uv-public-pypackage @ https://github.com/astral-test/uv-public-pypackage.git"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_raw_error() -> Result<()> {
    ...
    // Provide a tag without a Git source.
    fv_snapshot!(context.filters(), context.add().arg("uv-public-pypackage @ git+https://github.com/astral-test/uv-public-pypackage").arg("--tag").arg("0.0.1").arg("--raw-sources"), @"
    success: false
    exit_code: 2
    ----- stdout -----
    ...
    Usage: fv add --cache-dir [CACHE_DIR] --tag <TAG> --exclude-newer <EXCLUDE_NEWER> <PACKAGES|--requirements <REQUIREMENTS>>
...
fn reinstall_local_source_trees() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().current_dir(&project_1).arg("../project2").arg("--editable"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // Running `fv add` should reinstall the project.
    fv_snapshot!(context.filters(), context.add().current_dir(&project_1).arg("../project2").arg("--editable"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_editable_error() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("flask @ https://files.pythonhosted.org/packages/61/80/ffe1da13ad9300f87c93af113edd0638c75138c42a0994becfacac078c06/flask-3.0.3-py3-none-any.whl").arg("--editable"), @"
    success: false
    exit_code: 2
    ----- stdout -----
...
fn add_unnamed() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("git+https://github.com/astral-test/uv-public-pypackage").arg("--tag=0.0.1"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_remove_dev() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("anyio==3.7.0").arg("--dev"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // `fv add` implies a full lock and sync, including development dependencies.
    let lock = context.read("fv.lock");
    ...
    fv_snapshot!(context.filters(), context.remove().arg("anyio"), @"
    success: false
    exit_code: 2
    ----- stdout -----

    ----- stderr -----
    hint: `anyio` is in the `dev` group (try: `fv remove anyio --group dev`)
    error: The dependency `anyio` could not be found in `project.dependencies`
    ");

    // Remove the dependency.
    fv_snapshot!(context.filters(), context.remove().arg("anyio").arg("--dev"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_remove_optional() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("anyio==3.7.0").arg("--optional=io"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    ----- stderr -----
    hint: `anyio` is an optional dependency (try: `fv remove anyio --optional io`)
    error: The dependency `anyio` could not be found in `project.dependencies`
    ");

    // Remove the dependency.
    fv_snapshot!(context.filters(), context.remove().arg("anyio").arg("--optional=io"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_remove_inline_optional() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("typing-extensions").arg("--optional=types"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.remove().arg("typing-extensions").arg("--optional=types"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_remove_workspace() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), add_cmd, @"
    success: false
    exit_code: 2
    ----- stdout -----
    ...
    // Install from the lockfile.
    fv_snapshot!(context.filters(), context.sync().arg("--frozen").current_dir(&child1), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // Remove the dependency.
    fv_snapshot!(context.filters(), context.remove().arg("child2").current_dir(&child1), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
/// `fv add --dev` should update `dev-dependencies` (rather than `dependency-groups.dev`) if a
...
/// `fv add --dev` should add to `dev-dependencies` (rather than `dependency-groups.dev`) if it
/// exists.
#[test]
...
/// `fv add --group dev` should update `dev-dependencies` (rather than `dependency-groups.dev`) if a
...
fn update_existing_dev_group() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("anyio==3.7.0").arg("--group").arg("dev"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
/// `fv add --group dev` should add to `dependency-groups` even if `dev-dependencies` exists.
#[test]
...
/// `fv remove --dev` should remove from both `dev-dependencies` and `dependency-groups.dev`.
#[test]
...
fn disallow_group_script_add() -> Result<()> {
    ...
    Usage: fv add --cache-dir [CACHE_DIR] --group <GROUP> --exclude-newer <EXCLUDE_NEWER> <PACKAGES|--requirements <REQUIREMENTS>>
...
/// `fv remove --group dev` should remove from both `dev-dependencies` and `dependency-groups.dev`.
#[test]
fn remove_both_dev_group() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.remove().arg("anyio").arg("--group").arg("dev"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_workspace_path() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("./child"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_path_implicit_workspace() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg(Path::new("packages").join("child")).current_dir(workspace.path()), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // `fv add` implies a full lock and sync, including development dependencies.
    let lock = fs_err::read_to_string(workspace.join("fv.lock"))?;
    ...
    // Install from the lockfile.
    fv_snapshot!(context.filters(), context.sync().arg("--frozen").current_dir(workspace.path()), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_path_no_workspace() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg(Path::new("packages").join("child")).current_dir(workspace.path()).arg("--no-workspace"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_path_adjacent_directory() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg(dependency.path()).current_dir(project.path()), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // `fv add` implies a full lock and sync, including development dependencies.
    let lock = fs_err::read_to_string(project.join("fv.lock"))?;
...
/// Check relative and absolute path handling with `fv add`.
///
/// TODO(tk): Currently `fv add` always relativizes paths in `pyproject.toml`,
/// this is a bug.
#[test]
fn add_relative_and_absolute_paths() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("../relative_dep").current_dir(project.path()), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.add().arg(absolute_dep.path()).current_dir(project.path()), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.add().arg(file_url.as_str()).current_dir(project.path()), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn update() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("requests[security]"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.add().arg("requests; python_version > '3.7'").args(["--extra=use_chardet_on_py3", "--extra=socks"]), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // preserved).
    fv_snapshot!(context.filters(), context.add().arg("requests @ git+https://github.com/psf/requests").arg("--tag=v2.32.3"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_update_marker() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("requests>=2.0,<2.29; python_version < '3.11'"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.add().arg("requests>=2.0,<2.20; python_version < '3.11'"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.add().arg("requests>=2.31 ; sys_platform == 'win32' and python_version > '3.11'"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.add().arg("requests>=2.10 ; sys_platform == 'win32'"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // Remove `requests`
    fv_snapshot!(context.filters(), context.remove().arg("requests"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn update_source_replace_url() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("requests @ git+https://github.com/psf/requests").arg("--tag=v2.32.2"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
/// If a source defined in `tool.fv.sources` but its name is not normalized, `fv add` should not
...
fn add_update_git_reference_project() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("https://github.com/astral-test/uv-public-pypackage.git"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.add().arg("uv-public-pypackage").arg("--tag=0.0.1"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.add().arg("uv-public-pypackage").arg("--branch=main"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.add().arg("uv-public-pypackage").arg("--rev=2005223fcad0e2c06daf2e14b93b790604868e1e"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_update_git_reference_script() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("--script=script.py").arg("https://github.com/astral-test/uv-public-pypackage.git"),
        @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.add().arg("--script=script.py").arg("uv-public-pypackage").arg("--branch=test-branch"),
        @"
    success: true
    exit_code: 0
    ----- stdout -----
...
/// If a source defined in `tool.fv.sources` but its name is not normalized, `fv remove` should
/// remove the source.
#[test]
#[cfg(feature = "test-git")]
fn remove_non_normalized_source() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.remove().arg("uv-public-pypackage"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_inexact() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("iniconfig==2.0.0"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.sync().arg("--frozen").arg("--inexact"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_preserves_indentation_in_pyproject_toml() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("requests==2.31.0"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_frozen() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("anyio==3.7.0").arg("--frozen"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    assert!(!context.temp_dir.join("fv.lock").exists());
...
fn add_no_sync() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("anyio==3.7.0").arg("--no-sync"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_reject_multiple_git_ref_flags() {
    ...
    Usage: fv add [OPTIONS] <PACKAGES|--requirements <REQUIREMENTS>>
...
fn add_error() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("xyz"), @"
    success: false
    exit_code: 1
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.add().arg("xyz").arg("--frozen"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    let lock = context.temp_dir.join("fv.lock");
    assert!(!lock.exists());
...
fn add_environment_yml_error() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("-r").arg("environment.yml"), @"
    success: false
    exit_code: 2
    ----- stdout -----
...
fn add_lower_bound() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("anyio"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_lower_bound_raw() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("anyio").arg("--raw"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_lower_bound_dev() -> Result<()> {
    ...
    // Adding `anyio` should include a lower-bound.
    fv_snapshot!(context.filters(), context.add().arg("anyio").arg("--dev"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_lower_bound_optional() -> Result<()> {
    ...
    // Adding `anyio` should include a lower-bound.
    fv_snapshot!(context.filters(), context.add().arg("anyio").arg("--optional=io"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_lower_bound_local() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("local-simple-a").arg("--index").arg(packse_index_url()).env_remove(EnvVars::UV_EXCLUDE_NEWER), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_non_project() -> Result<()> {
    ...
    // dependencies.
    fv_snapshot!(context.filters(), context.add().arg("iniconfig"), @"
    success: false
    exit_code: 2
    ----- stdout -----

    ----- stderr -----
    error: Project is missing a `[project]` table; add a `[project]` table to use production dependencies, or run `fv add --dev` instead
    ");

    // Adding `iniconfig` as optional should fail, since virtual workspace roots don't support
    // optional dependencies.
    fv_snapshot!(context.filters(), context.add().arg("iniconfig").arg("--optional").arg("async"), @"
    success: false
    exit_code: 2
    ----- stdout -----

    ----- stderr -----
    error: Project is missing a `[project]` table; add a `[project]` table to use optional dependencies, or run `fv add --dev` instead
    ");

    // Adding `iniconfig` as a dev dependency should succeed.
    fv_snapshot!(context.filters(), context.add().arg("iniconfig").arg("--dev"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_virtual_empty() -> Result<()> {
    // testing how `fv add` reacts to a pyproject with no `[project]` and nothing useful to it
    let context = fv_test::test_context!("3.12");
...
fn add_virtual_dependency_group() -> Result<()> {
    // testing basic `fv add --group` functionality
...
fn add_empty_requirements_group() -> Result<()> {
    // Test that `fv add -r requirements.txt --group <name>` creates an empty group
...
fn add_empty_requirements_optional() -> Result<()> {
    // Test that `fv add -r requirements.txt --optional <extra>` creates an empty extra
    // when the requirements file is empty
    let context = fv_test::test_context!("3.12");
...
fn remove_virtual_empty() -> Result<()> {
    // testing how `fv remove` reacts to a pyproject with no `[project]` and nothing useful to it
    let context = fv_test::test_context!("3.12");
    ...
    fv_snapshot!(context.filters(), context.remove()
        .arg("sortedcontainers"), @"
    success: false
    exit_code: 2
    ----- stdout -----
    ...
    ----- stderr -----
    error: The dependency `sortedcontainers` could not be found in `tool.fv.dev-dependencies` or `tool.fv.dependency-groups.dev`
    ");
...
fn remove_virtual_dependency_group() -> Result<()> {
    // testing basic `fv remove --group` functionality
    // when the pyproject.toml is fully virtual (no `[project]`)
    let context = fv_test::test_context!("3.12");
...
fn add_requirements_file() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("-r").arg("requirements.txt"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.add().arg("-r").arg("-").stdin(std::fs::File::open(requirements_txt)?), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.add().arg("-r").arg("setup.py"), @"
    success: false
    exit_code: 2
    ----- stdout -----

    ----- stderr -----
    error: Adding requirements from a `setup.py` is not supported in `fv add`
    ");
    ...
    Usage: fv add --cache-dir [CACHE_DIR] --exclude-newer <EXCLUDE_NEWER> <PACKAGES|--requirements <REQUIREMENTS>>
...
fn add_requirements_file_non_editable() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("-r").arg("requirements.txt").arg("--no-workspace"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_requirements_file_editable_override() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("-r").arg("requirements.txt").arg("--no-workspace").arg("--no-editable"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_requirements_file_with_marker_flag() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("-r").arg("requirements.win.txt").arg("-m").arg("python_version == '3.11'"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // Reset the project.
    pyproject_toml.write_str(base_pyproject_toml)?;
    fs_err::remove_file(context.temp_dir.join("fv.lock"))?;

    // Add dependencies with a marker that applies for the current target.
    fv_snapshot!(context.filters(), context.add().arg("-r").arg("requirements.win.txt").arg("-m").arg("python_version == '3.12'"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_requirements_file_constraints() -> Result<()> {
    ...
    requirements_txt.write_str(indoc! {r"
            ...
            #    fv pip compile --cache-dir [CACHE_DIR] requirements.in -o requirements.txt
            anyio==3.7.1
    ...
    fv_snapshot!(context.filters(), context.add().arg("-r").arg("requirements.in").arg("-c").arg("requirements.txt"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_group() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("anyio==3.7.0").arg("--group").arg("test"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.add().arg("requests").arg("--group").arg("test"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.add().arg("anyio==3.7.0").arg("--group").arg("second"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.add().arg("anyio==3.7.0").arg("--group").arg("alpha"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_group_normalize() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("iniconfig").arg("--group").arg("cloud_export_to_parquet"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.add().arg("typing-extensions").arg("--group").arg("cloud-export-to-parquet"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.remove().arg("iniconfig").arg("--group").arg("cloud_export_to_parquet"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.remove().arg("typing-extensions").arg("--group").arg("cloud-export-to-parquet"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_group_between_commented_groups() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("anyio==3.7.0").arg("--group").arg("eta"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn remove_group() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.remove().arg("anyio").arg("--group").arg("test"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_script() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("anyio").arg("--script").arg("script.py"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_script_bounds() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("anyio").arg("--bounds").arg("minor").arg("--script").arg("script.py"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_script_relative_path() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("./project").arg("--editable").arg("--script").arg("script.py"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_script_settings() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("anyio>=3").arg("--script").arg("script.py"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_script_without_metadata_table() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().args(["rich", "requests<3"]).arg("--script").arg("script.py"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_extensionless_script() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().args(["rich", "requests<3"]).arg("--script").arg("script"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
async fn add_requirements_from_remote_script() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("-r").arg(&script_url), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn remove_repeated() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.remove().arg("anyio").arg("--optional").arg("foo"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_remove_script_lock() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.remove().arg("anyio").arg("--script").arg("script.py"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn remove_last_dep_script() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.remove().arg("rich").arg("--script").arg("script.py"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_include_default_groups() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("typing-extensions"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn remove_include_default_groups() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.remove().arg("typing-extensions"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
/// Revert changes to the `pyproject.toml` and `fv.lock` when the `add` operation fails.
#[test]
fn fail_to_add_revert_project() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("./child").arg("--no-workspace"), @r#"
    success: false
    exit_code: 1
    ----- stdout -----
...
fn fail_to_edit_revert_project() -> Result<()> {
    ...
    let before = fs_err::read_to_string(context.temp_dir.join("fv.lock"))?;
    ...
    let after = fs_err::read_to_string(context.temp_dir.join("fv.lock"))?;
    assert_eq!(before, after);

    Ok(())
}

/// Revert changes to the root `pyproject.toml` and `fv.lock` when the `add` operation fails.
#[test]
fn fail_to_add_revert_workspace_root() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("./broken"), @r#"
    success: false
    exit_code: 1
    ----- stdout -----
...
fn fail_to_add_revert_workspace_member() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().current_dir(&project).arg("../broken"), @r#"
    success: false
    exit_code: 1
    ----- stdout -----
...
fn sorted_dependencies() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().args(["typing-extensions", "anyio"]), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn naive_sorted_dependencies() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().args(["pytest-randomly"]), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn sorted_dependencies_name_specifiers() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), universal_windows_filters=true, context.add().args(["pytest-mock"]), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), universal_windows_filters=true, context.add().args(["pytest-randomly"]), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn sorted_dependencies_with_include_group() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().args(["--dev", "pytest-randomly"]), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn sorted_dependencies_new_dependency_after_include_group() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().args(["--dev", "pytest"]), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn custom_dependencies() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("pydantic").arg("--frozen"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn update_offset() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().args(["typing-extensions", "iniconfig"]), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_shadowed_name() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("dagster-webserver==1.6.13"), @"
    success: false
    exit_code: 1
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.add().arg("dagster-webserver>=1.6.11,<1.7.0"), @"
    success: false
    exit_code: 1
    ----- stdout -----
...
fn add_warn_index_url() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("idna").arg("--index-url").arg("https://pypi.org/simple"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    let lock = fs_err::read_to_string(context.temp_dir.join("fv.lock"))?;
    ...
    fv_snapshot!(context.filters(), context.add().arg("iniconfig").arg("--extra-index-url").arg("https://test.pypi.org/simple"), @"
    success: false
    exit_code: 1
    ----- stdout -----
...
fn add_index() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("iniconfig==2.0.0").arg("--index").arg("https://pypi.org/simple"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.add().arg("jinja2").arg("--index").arg("pytorch=https://astral-sh.github.io/pytorch-mirror/whl/cu121"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.add().arg("jinja2").arg("--index").arg("pytorch=https://test.pypi.org/simple"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.add().arg("typing-extensions").arg("--index").arg("https://pypi.org/simple"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.add().arg("typing-extensions").arg("--index").arg("https://test.pypi.org/simple"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_default_index_url() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("iniconfig").arg("--default-index").arg("https://test.pypi.org/simple"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.add().arg("typing-extensions").arg("--default-index").arg("https://pypi.org/simple"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
async fn add_index_credentials() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("iniconfig==2.0.0").env(EnvVars::UV_DEFAULT_INDEX, proxy.authenticated_url("public", "heron", "/basic-auth/simple")), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_index_with_existing_relative_path_index() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("iniconfig").arg("--index").arg("./test-index"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_index_with_ambiguous_relative_path() -> Result<()> {
    ...
    #[cfg(windows)]
    fv_snapshot!(context.filters(), context.add().arg("iniconfig").arg("--index").arg("test-index"), @r"
    success: false
    exit_code: 2
    ----- stdout -----
...
fn add_group_comment() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("--group").arg("dev").arg("sniffio"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_index_comments() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("iniconfig==2.0.0").env(EnvVars::UV_DEFAULT_INDEX, "https://pypi.org/simple"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_self() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("anyio[types]").arg("--optional").arg("all"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.add().arg("anyio[types]").arg("--dev"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_direct_url_subdirectory() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("root @ https://github.com/user-attachments/files/18216295/subdirectory-test.tar.gz#subdirectory=packages/root"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_direct_url_subdirectory_raw() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("root @ https://github.com/user-attachments/files/18216295/subdirectory-test.tar.gz#subdirectory=packages/root").arg("--raw-sources"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_preserves_first_own_line_comment() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("charset-normalizer"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
/// Accept requirements, not just package names, in `fv remove`.
#[test]
fn remove_requirement() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.remove().arg("flask[dotenv]"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn remove_all_with_comments() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.remove().arg("duct").arg("minilog"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_with_build_constraints() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("requests==1.2"), @"
    success: false
    exit_code: 1
    ----- stdout -----
...
fn add_unsupported_git_scheme() {
    ...
    fv_snapshot!(context.filters(), context.add().arg("git+fantasy://ferris/dreams/of/urls@7701ffcbae245819b828dc5f885a5201158897ef"), @"
    success: false
    exit_code: 2
    ----- stdout -----
...
async fn add_index_url_in_keyring() -> Result<()> {
    let keyring_context = fv_test::test_context!("3.12");
...
/// If fv receives an authentication failure from a configured index, it
...
/// fv should continue searching the default index if it receives an
...
/// fv should only fall through on 404s if an empty list is specified
...
/// fv should not report a credential error on a missing package for pytorch since
...
fn add_missing_package_on_pytorch() -> Result<()> {
    ...
    fv_snapshot!(context.add().arg("fakepkg"), @"
    success: false
    exit_code: 1
    ----- stdout -----
...
async fn add_unexpected_error_code() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("anyio").arg("--index").arg(server.uri())
        .env(EnvVars::UV_TEST_NO_HTTP_RETRY_DELAY, "true")
...
/// fv should fail to parse `pyproject.toml` if `ignore-error-codes`
...
/// fv should fail to parse `pyproject.toml` if `require-python`
...
fn add_invalid_requires_python() -> Result<()> {
    ...
    fv_snapshot!(context.add().arg("anyio"), @r#"
    success: false
    exit_code: 2
    ----- stdout -----
...
fn add_auth_policy_always_without_credentials() -> Result<()> {
    ...
    fv_snapshot!(context.add().arg("anyio"), @"
    success: false
    exit_code: 2
    ----- stdout -----
    ...
    fv_snapshot!(context.pip_install().arg("black"), @"
    success: false
    exit_code: 2
    ----- stdout -----
...
/// If fv receives a 302 redirect to a cross-origin server, it should not forward
...
async fn add_redirect_cross_origin() -> Result<()> {
    ...
    fv_snapshot!(filters, context.add().arg("--default-index").arg(redirect_url.as_str()).arg("anyio"), @"
    success: false
    exit_code: 1
    ----- stdout -----
...
/// If fv receives a 302 redirect to a cross-origin server with credentials
...
/// fv currently fails to look up keyring credentials on a cross-origin redirect.
#[tokio::test]
async fn add_redirect_with_keyring_cross_origin() -> Result<()> {
    ...
    fv_snapshot!(filters, context.add().arg("--default-index")
...
/// If fv receives a cross-origin 302 redirect, it should use credentials from netrc
...
async fn pip_install_redirect_with_netrc_cross_origin() -> Result<()> {
    ...
    fv_snapshot!(filters, context.pip_install()
        .arg("anyio")
        .arg("--index-url")
        .arg(redirect_url.as_str())
...
fn add_ambiguous() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("--group").arg("bar").arg("anyio"), @"
    success: false
    exit_code: 2
    ----- stdout -----
...
fn add_optional_normalize() -> Result<()> {
    ...
    // Add with a non-normalized group name.
    fv_snapshot!(context.filters(), context.add().arg("iniconfig").arg("--optional").arg("cloud_export_to_parquet"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // Add with a normalized group name (which doesn't match the `pyproject.toml`).
    fv_snapshot!(context.filters(), context.add().arg("typing-extensions").arg("--optional").arg("cloud-export-to-parquet"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // Remove with a non-normalized group name.
    fv_snapshot!(context.filters(), context.remove().arg("iniconfig").arg("--optional").arg("cloud_export_to_parquet"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // Remove with a normalized group name (which doesn't match the `pyproject.toml`).
    fv_snapshot!(context.filters(), context.remove().arg("typing-extensions").arg("--optional").arg("cloud-export-to-parquet"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
/// Test `fv add` with different kinds of bounds and constraints.
#[test]
fn add_bounds() -> Result<()> {
    let context = fv_test::test_context!("3.12");

    // Set bounds in `fv.toml`
    ...
    fv_snapshot!(context.filters(), context.add().arg("idna"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.add().arg("anyio").arg("--bounds").arg("minor"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.add().arg("anyio==4.2").arg("idna").arg("--bounds").arg("minor"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.add().arg("sniffio").arg("--bounds").arg("minor"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
/// contain a workspace definition, so `fv add` should create one.
#[test]
...
fn add_no_install_project() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("iniconfig").arg("--no-install-project"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_git_lfs_error() -> Result<()> {
    ...
    fv_snapshot!(context.filters(), context.add().arg("typing-extensions").arg("--lfs"), @"
    success: false
    exit_code: 2
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.add().arg("typing-extensions").env(EnvVars::UV_GIT_LFS, "true"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.add().arg("typing-extensions").env(EnvVars::UV_GIT_LFS, "true").arg("--lfs"), @"
    success: false
    exit_code: 2
    ----- stdout -----
    ...
    fv_snapshot!(context.filters(), context.add().arg("typing-extensions").env(EnvVars::UV_GIT_LFS, "false").arg("--lfs"), @"
    success: false
    exit_code: 2
    ----- stdout -----
