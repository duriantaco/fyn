...
impl From<&fyn_platform_tags::Platform> for Platform {
    fn from(value: &fyn_platform_tags::Platform) -> Self {
        Self {
            os: Os::from(value.os()),
...
mod tests {
    ...
    fn test_from_platform_tags_platform() {
        // Test conversion from fyn_platform_tags::Platform to fyn_platform::Platform
        let tags_platform = fyn_platform_tags::Platform::new(
            fyn_platform_tags::Os::Windows,
        ...
        // Test with manylinux
        let tags_platform_linux = fyn_platform_tags::Platform::new(
            fyn_platform_tags::Os::Manylinux {
                major: 2,
                minor: 17,
            },
            fyn_platform_tags::Arch::Aarch64,
        );
