...
//! ```
//! use std::str::FromStr;
//! use fyn_pep508::{Requirement, VerbatimUrl};
...
mod tests {
    ...
    use fyn_normalize::{ExtraName, InvalidNameError, PackageName};
    use fyn_pep440::{Operator, Version, VersionPattern, VersionSpecifier};
