...
impl From<&fv_platform_tags::Platform> for Platform {
    fn from(value: &fv_platform_tags::Platform) -> Self {
        Self {
            os: Os::from(value.os()),
...
mod tests {
    ...
    fn test_from_platform_tags_platform() {
        // Test conversion from fv_platform_tags::Platform to fv_platform::Platform
        let tags_platform = fv_platform_tags::Platform::new(
            fv_platform_tags::Os::Windows,
            fv_platform_tags::Arch::X86_64,
        );
        ...
        // Test with manylinux
        let tags_platform_linux = fv_platform_tags::Platform::new(
            fv_platform_tags::Os::Manylinux {
                major: 2,
                minor: 17,
            },
            fv_platform_tags::Arch::Aarch64,
        );
