...
use fv_pypi_types::{HashDigest, HashDigests};
        ...
        match resolved_dist {
            ResolvedDist::Installable { dist, .. } => match dist.as_ref() {
                Dist::Built(BuiltDist::Registry(wheels)) => {
                    ...
                    Self::Registry {
                        specifier: fv_pep440::VersionSpecifiers::from(
                            fv_pep440::VersionSpecifier::equals_version(
                ...
                Dist::Source(SourceDist::Registry(sdist)) => Self::Registry {
                    specifier: fv_pep440::VersionSpecifiers::from(
                        fv_pep440::VersionSpecifier::equals_version(sdist.version.clone()),
                    ),
            ...
            ResolvedDist::Installed { dist } => Self::Registry {
                specifier: fv_pep440::VersionSpecifiers::from(
                    fv_pep440::VersionSpecifier::equals_version(dist.version().clone()),
                ),
                index: None,
                conflict: None,
            },
