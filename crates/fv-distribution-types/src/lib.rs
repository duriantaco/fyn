...
use fv_fs::normalize_absolute_path;
use fv_git_types::GitUrl;
use fv_normalize::PackageName;
use fv_pep440::Version;
use fv_pep508::{Pep508Url, VerbatimUrl};
use fv_pypi_types::{
...
impl Identifier for DisplaySafeUrl {
    fn distribution_id(&self) -> DistributionId {
        DistributionId::Url(fv_cache_key::CanonicalUrl::new(self))
    }

    fn resource_id(&self) -> ResourceId {
        ResourceId::Url(fv_cache_key::RepositoryUrl::new(self))
    }
}
