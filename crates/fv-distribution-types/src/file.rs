...
use fv_pep440::{VersionSpecifiers, VersionSpecifiersParseError};
use fv_pep508::split_scheme;
use fv_pypi_types::{CoreMetadata, HashDigests, Yanked};
use fv_redacted::{DisplaySafeUrl, DisplaySafeUrlError};
use fv_small_str::SmallString;

/// Error converting [`fv_pypi_types::PypiFile`] to [`distribution_type::File`].
...
/// Internal analog to [`fv_pypi_types::PypiFile`].
