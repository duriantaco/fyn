...
use fyn_distribution::{DistributionDatabase, Reporter};
use fyn_distribution_filename::{DistExtension, SourceDistFilename, WheelFilename};
...
use fyn_pep508::{UnnamedRequirement, VersionOrUrl};
use fyn_pypi_types::{Metadata10, ParsedUrl, PyProjectToml, VerbatimParsedUrl};
use fyn_resolver::{InMemoryIndex, MetadataResponse};
...
impl<'a, Context: BuildContext> NamedRequirementsResolver<'a, Context> {
    ...
    async fn resolve_requirement(
        ...
        index: &InMemoryIndex,
        database: &DistributionDatabase<'a, Context>,
    ) -> Result<fyn_pep508::Requirement<VerbatimParsedUrl>, Error> {
            ...
            .is_some_and(|ext| ext.eq_ignore_ascii_case("whl"))
        {
            ...
            return Ok(fyn_pep508::Requirement {
                name: filename.name,
