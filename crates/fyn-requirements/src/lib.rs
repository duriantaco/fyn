...
pub enum Error {
    ...
    #[error(transparent)]
    Distribution(#[from] Box<fyn_distribution::Error>),
...
impl Error {
    ...
    pub(crate) fn from_dist(dist: Dist, err: fyn_distribution::Error) -> Self {
        Self::Dist(
...
) -> Result<Option<Dist>, fyn_distribution_types::Error> {
