//! Environment variables used or supported by fv.
//! Used to generate `docs/reference/environment.md`.
use fv_macros::{attr_added_in, attr_env_var_pattern, attr_hidden, attribute_env_vars_metadata};

/// Declares all environment variable used throughout `fv` and its crates.
pub struct EnvVars;

#[attribute_env_vars_metadata]
impl EnvVars {
    /// The path to the binary that was used to invoke fv.
    ///
    /// This is propagated to all subprocesses spawned by fv.
    ///
    ...
    /// Equivalent to the `--offline` command-line argument. If set, fv will disable network access.
    #[attr_added_in("0.5.9")]
    pub const UV_OFFLINE: &'static str = "UV_OFFLINE";

    /// Equivalent to the `--default-index` command-line argument. If set, fv will use
    ...
    /// Equivalent to the `--index` command-line argument. If set, fv will use this
    /// space-separated list of URLs as additional indexes when searching for packages.
    #[attr_added_in("0.4.23")]
    pub const UV_INDEX: &'static str = "UV_INDEX";

    /// Equivalent to the `--index-url` command-line argument. If set, fv will use this
    ...
    /// Equivalent to the `--extra-index-url` command-line argument. If set, fv will
    /// use this space-separated list of URLs as additional indexes when searching for packages.
    /// (Deprecated: use `UV_INDEX` instead.)
    #[attr_added_in("0.1.3")]
    pub const UV_EXTRA_INDEX_URL: &'static str = "UV_EXTRA_INDEX_URL";

    /// Equivalent to the `--find-links` command-line argument. If set, fv will use this
    ...
    /// Equivalent to the `--no-sources` command-line argument. If set, fv will ignore
    /// `[tool.fv.sources]` annotations when resolving dependencies.
    #[attr_added_in("0.9.8")]
    pub const UV_NO_SOURCES: &'static str = "UV_NO_SOURCES";

    /// Equivalent to the `--cache-dir` command-line argument. If set, fv will use this
    ...
    /// Override the default lockfile name (`fv.lock`). Useful when a project
    /// needs multiple lockfiles for different platforms or configurations.
    #[attr_added_in("0.10.13")]
    pub const UV_LOCKFILE: &'static str = "UV_LOCKFILE";

    /// Equivalent to the `--no-cache` command-line argument. If set, fv will not use the
    /// cache for any operations.
    #[attr_added_in("0.1.2")]
    pub const UV_NO_CACHE: &'static str = "UV_NO_CACHE";

    /// Maximum cache size in bytes. When the cache exceeds this size, oldest
    /// entries will be pruned. Supports suffixes: `k`/`K` (KiB), `m`/`M` (MiB),
    /// `g`/`G` (GiB). Example: `UV_CACHE_MAX_SIZE=2G`.
    #[attr_added_in("0.10.13")]
    pub const UV_CACHE_MAX_SIZE: &'static str = "UV_CACHE_MAX_SIZE";

    /// Equivalent to the `--resolution` command-line argument. For example, if set to
    /// `lowest-direct`, fv will install the lowest compatible versions of all direct dependencies.
    ...
    /// `allow`, fv will allow pre-release versions for all dependencies.
    ...
    /// Equivalent to the `--system` command-line argument. If set to `true`, fv will
    ...
    /// Equivalent to the `--python` command-line argument. If set to a path, fv will use
    ...
    /// fv will allow the installation of packages that conflict with system-installed packages.
    ///
    ...
    /// Equivalent to the `--native-tls` command-line argument. If set to `true`, fv will
    ...
    ///
    /// For example, if set to `unsafe-best-match`, fv will consider versions of a given package
    ...
    /// fv will require that all dependencies have a hash specified in the requirements file.
    #[attr_added_in("0.1.34")]
    pub const UV_REQUIRE_HASHES: &'static str = "UV_REQUIRE_HASHES";

    /// Equivalent to the `--constraints` command-line argument. If set, fv will use this
    /// file as the constraints file. Uses space-separated list of files.
    #[attr_added_in("0.1.36")]
    pub const UV_CONSTRAINT: &'static str = "UV_CONSTRAINT";

    /// Equivalent to the `--build-constraints` command-line argument. If set, fv will use this file
    ...
    /// Equivalent to the `--overrides` command-line argument. If set, fv will use this file
    /// as the overrides file. Uses space-separated list of files.
    #[attr_added_in("0.2.22")]
    pub const UV_OVERRIDE: &'static str = "UV_OVERRIDE";

    /// Equivalent to the `--excludes` command-line argument. If set, fv will use this
    /// as the excludes file. Uses space-separated list of files.
    #[attr_added_in("0.9.8")]
    pub const UV_EXCLUDE: &'static str = "UV_EXCLUDE";

    /// Equivalent to the `--link-mode` command-line argument. If set, fv will use this as
    /// a link mode.
    #[attr_added_in("0.1.40")]
    pub const UV_LINK_MODE: &'static str = "UV_LINK_MODE";

    /// Equivalent to the `--no-build-isolation` command-line argument. If set, fv will
    ...
    ///
    /// Used to override fv in the output header of the `requirements.txt` files generated by
    /// `fv pip compile`. Intended for use-cases in which `fv pip compile` is called from within a wrapper
    ...
    /// Equivalent to the `--keyring-provider` command-line argument. If set, fv
    ...
    /// local `fv.toml` file to use as the configuration file.
    #[attr_added_in("0.1.34")]
    pub const UV_CONFIG_FILE: &'static str = "UV_CONFIG_FILE";

    /// Equivalent to the `--no-config` command-line argument. If set, fv will not read
    ...
    /// Equivalent to the `--isolated` command-line argument. If set, fv will avoid discovering
    /// a `pyproject.toml` or `fv.toml` file.
    #[attr_added_in("0.8.14")]
    pub const UV_ISOLATED: &'static str = "UV_ISOLATED";

    /// Equivalent to the `--exclude-newer` command-line argument. If set, fv will
    /// exclude distributions published after the specified date.
    #[attr_added_in("0.2.12")]
    pub const UV_EXCLUDE_NEWER: &'static str = "UV_EXCLUDE_NEWER";

    /// Whether fv should prefer system or managed Python versions.
    #[attr_added_in("0.3.2")]
    pub const UV_PYTHON_PREFERENCE: &'static str = "UV_PYTHON_PREFERENCE";

    /// Require use of fv-managed Python versions.
    #[attr_added_in("0.6.8")]
    pub const UV_MANAGED_PYTHON: &'static str = "UV_MANAGED_PYTHON";

    /// Disable use of fv-managed Python versions.
    #[attr_added_in("0.6.8")]
    ...
    /// `--no-python-downloads` option. Whether fv should allow Python downloads.
    #[attr_added_in("0.3.2")]
    ...
    /// Equivalent to the `--compile-bytecode` command-line argument. If set, fv
    ...
    /// Equivalent to the `--no-editable` command-line argument. If set, fv
    ...
    /// Equivalent to the `--dev` command-line argument. If set, fv will include
    /// development dependencies.
    #[attr_added_in("0.8.7")]
    pub const UV_DEV: &'static str = "UV_DEV";

    /// Equivalent to the `--no-dev` command-line argument. If set, fv will exclude
    /// development dependencies.
    #[attr_added_in("0.8.7")]
    pub const UV_NO_DEV: &'static str = "UV_NO_DEV";

    /// Equivalent to the `--no-group` command-line argument. If set, fv will disable
    ...
    /// Equivalent to the `--no-default-groups` command-line argument. If set, fv will
    /// not select the default dependency groups defined in `tool.fv.default-groups`.
    #[attr_added_in("0.9.9")]
    pub const UV_NO_DEFAULT_GROUPS: &'static str = "UV_NO_DEFAULT_GROUPS";

    /// Equivalent to the `--no-binary` command-line argument. If set, fv will install
    ...
    /// Equivalent to the `--no-binary-package` command line argument. If set, fv will
    ...
    /// Equivalent to the `--no-build` command-line argument. If set, fv will not build
    /// source distributions.
    #[attr_added_in("0.1.40")]
    pub const UV_NO_BUILD: &'static str = "UV_NO_BUILD";

    /// Equivalent to the `--no-build-package` command line argument. If set, fv will
    ...
    /// Equivalent to the `--no-sources-package` command line argument. If set, fv will
    /// ignore the `tool.fv.sources` table for the given space-delimited list of packages.
    ...
    /// endpoint of the index to use with `fv publish`.
    #[attr_added_in("0.4.16")]
    pub const UV_PUBLISH_URL: &'static str = "UV_PUBLISH_URL";

    /// Equivalent to the `--token` command-line argument in `fv publish`. If set, uv
    /// will use this token (with the username `__token__`) for publishing.
    #[attr_added_in("0.4.16")]
    pub const UV_PUBLISH_TOKEN: &'static str = "UV_PUBLISH_TOKEN";

    /// Equivalent to the `--index` command-line argument in `fv publish`. If
    /// set, fv will use the index with this name in the configuration for publishing.
    #[attr_added_in("0.5.8")]
    pub const UV_PUBLISH_INDEX: &'static str = "UV_PUBLISH_INDEX";

    /// Equivalent to the `--username` command-line argument in `fv publish`. If
    /// set, fv will use this username for publishing.
    #[attr_added_in("0.4.16")]
    pub const UV_PUBLISH_USERNAME: &'static str = "UV_PUBLISH_USERNAME";

    /// Equivalent to the `--password` command-line argument in `fv publish`. If
    /// set, fv will use this password for publishing.
    #[attr_added_in("0.4.16")]
    ...
    /// Equivalent to the `--no-attestations` command-line argument in `fv publish`. If set,
    /// fv will skip uploading any collected attestations for the published distributions.
    #[attr_added_in("0.9.12")]
    pub const UV_PUBLISH_NO_ATTESTATIONS: &'static str = "UV_PUBLISH_NO_ATTESTATIONS";

    /// Equivalent to the `--no-sync` command-line argument. If set, fv will skip updating
    /// the environment.
    #[attr_added_in("0.4.18")]
    pub const UV_NO_SYNC: &'static str = "UV_NO_SYNC";

    /// Equivalent to the `--locked` command-line argument. If set, fv will assert that the
    /// `fv.lock` remains unchanged.
    #[attr_added_in("0.4.25")]
    pub const UV_LOCKED: &'static str = "UV_LOCKED";

    /// Equivalent to the `--frozen` command-line argument. If set, fv will run without
    /// updating the `fv.lock` file.
    #[attr_added_in("0.4.25")]
    ...
    /// integrity checks and allowing fv to install potentially malicious ZIP files. If uv rejects
    ...
    /// Sets the maximum number of in-flight concurrent downloads that fv will
    /// perform at any given time.
    #[attr_added_in("0.1.43")]
    pub const UV_CONCURRENT_DOWNLOADS: &'static str = "UV_CONCURRENT_DOWNLOADS";

    /// Sets the maximum number of source distributions that fv will build
    ...
    /// Specifies the directory where fv stores managed tools.
    ...
    /// Equivalent to the `--bare` argument for `fv init`. If set, fv will only create a
    /// `pyproject.toml`.
    #[attr_added_in("0.10.7")]
    pub const UV_INIT_BARE: &'static str = "UV_INIT_BARE";

    /// Equivalent to the `--build-backend` argument for `fv init`. Determines the default backend
    ...
    /// Managed Python installations information is hardcoded in the `fv` binary.
    ///
    ...
    /// of Python than the ones hardcoded into this build of `fv`.
    ...
    /// Equivalent to the `--clear` command-line argument. If set, fv will remove any
    ...
    /// Used to set the fv commit hash at build time via `build.rs`.
    #[attr_hidden]
    #[attr_added_in("0.1.11")]
    pub const UV_COMMIT_HASH: &'static str = "UV_COMMIT_HASH";

    /// Used to set the fv commit short hash at build time via `build.rs`.
    #[attr_hidden]
    #[attr_added_in("0.1.11")]
    pub const UV_COMMIT_SHORT_HASH: &'static str = "UV_COMMIT_SHORT_HASH";

    /// Used to set the fv commit date at build time via `build.rs`.
    #[attr_hidden]
    #[attr_added_in("0.1.11")]
    pub const UV_COMMIT_DATE: &'static str = "UV_COMMIT_DATE";

    /// Used to set the fv tag at build time via `build.rs`.
    #[attr_hidden]
    #[attr_added_in("0.1.11")]
    pub const UV_LAST_TAG: &'static str = "UV_LAST_TAG";

    /// Used to set the fv tag distance from head at build time via `build.rs`.
    #[attr_hidden]
    #[attr_added_in("0.1.11")]
    ...
    ///
    /// When populated, fv will run additional tests that require this functionality.
    #[attr_hidden]
    ...
    ///
    /// When populated, fv will run additional tests that verify fallback behavior
    ...
    ///
    /// When populated, fv will run additional tests that cover cross-filesystem linking.
    #[attr_hidden]
    #[attr_added_in("0.10.5")]
    ...
    ///
    /// When populated, fv will run additional tests that exercise EMLINK recovery.
    #[attr_hidden]
    ...
    /// Marker variable to track whether `PYTHONHOME` was set by fv.
    ...
    /// If set, fv will use this file for mTLS authentication.
    ...
    /// Path to the `.git` directory. Ignored by `fv` when performing fetch.
    #[attr_hidden]
    #[attr_added_in("0.0.5")]
    pub const GIT_DIR: &'static str = "GIT_DIR";

    /// Path to the git working tree. Ignored by `fv` when performing fetch.
    #[attr_hidden]
    #[attr_added_in("0.0.5")]
    pub const GIT_WORK_TREE: &'static str = "GIT_WORK_TREE";

    /// Path to the index file for staged changes. Ignored by `fv` when performing fetch.
    #[attr_hidden]
    #[attr_added_in("0.0.5")]
    pub const GIT_INDEX_FILE: &'static str = "GIT_INDEX_FILE";

    /// Path to where git object files are located. Ignored by `fv` when performing fetch.
    #[attr_hidden]
    #[attr_added_in("0.0.5")]
    pub const GIT_OBJECT_DIRECTORY: &'static str = "GIT_OBJECT_DIRECTORY";

    /// Alternate locations for git objects. Ignored by `fv` when performing fetch.
    #[attr_hidden]
    #[attr_added_in("0.0.5")]
    ...
    ///
    /// When fv is in "offline" mode, only the "file" protocol is allowed.
    #[attr_hidden]
    #[attr_added_in("0.6.13")]
    ...
    ///
    /// For example, we run some tests in ~/.local/share/fv/tests.
    /// And if the user's `$HOME` directory is a git repository,
    /// this will change the behavior of some tests. Setting
    /// `GIT_CEILING_DIRECTORIES=/home/andrew/.local/share/fv/tests` will
    ...
    ///
    /// `fv publish` may attempt trusted publishing flows when set
    /// to `true`.
    #[attr_added_in("0.4.16")]
    ...
    /// The standard `PAGER` posix env var. Used by `fv` to configure the appropriate pager.
    #[attr_added_in("0.4.18")]
    ...
    /// If set, fv will use this value as the log level for its `--verbose` output. Accepts
    ...
    /// This is used by fv particularly on windows to show more details during a platform exception.
    ///
    /// For example:
    ///
    ...
    /// Use to set the stack size used by fv.
    ///
    ...
    /// `.env` files from which to load environment variables when executing `fv run` commands.
    #[attr_added_in("0.4.30")]
    pub const UV_ENV_FILE: &'static str = "UV_ENV_FILE";

    /// Ignore `.env` files when executing `fv run` commands.
    #[attr_added_in("0.4.30")]
    pub const UV_NO_ENV_FILE: &'static str = "UV_NO_ENV_FILE";

    /// The URL from which to download fv using the standalone installer and `self update` feature,
    ...
    /// Used ephemeral environments like CI to install fv to a specific path while preventing
    ...
    /// The URL from which to download fv using the standalone installer. By default, installs from
    ...
    /// Avoid modifying the `PATH` environment variable when installing fv using the standalone
    ...
    /// Skip writing `fv` installer metadata files (e.g., `INSTALLER`, `REQUESTED`, and `direct_url.json`) to site-packages `.dist-info` directories.
    #[attr_added_in("0.5.7")]
    ...
    /// Number of times that `fv run` has been recursively invoked. Used to guard against infinite
    /// recursion, e.g., when `fv run`` is used in a script shebang.
    #[attr_hidden]
    #[attr_added_in("0.5.31")]
    pub const UV_RUN_RECURSION_DEPTH: &'static str = "UV_RUN_RECURSION_DEPTH";

    /// Number of times that `fv run` will allow recursive invocations, before exiting with an
    /// error.
    #[attr_hidden]
    #[attr_added_in("0.5.31")]
    pub const UV_RUN_MAX_RECURSION_DEPTH: &'static str = "UV_RUN_MAX_RECURSION_DEPTH";

    /// Overrides terminal width used for wrapping. This variable is not read by fv directly.
    ///
    ...
    /// Disable GitHub-specific requests that allow fv to skip `git fetch` in some circumstances.
    #[attr_added_in("0.7.13")]
    pub const UV_NO_GITHUB_FAST_PATH: &'static str = "UV_NO_GITHUB_FAST_PATH";

    /// Authentication token for Hugging Face requests. When set, fv will use this token
    ...
    /// The pyx authentication token (e.g., `eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9...`), as output by `fv auth token`.
    #[attr_added_in("0.8.15")]
    ...
    /// Specifies the directory where fv stores pyx credentials.
    #[attr_added_in("0.8.15")]
