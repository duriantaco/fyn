...
use fv_pypi_types::{BaseUrl, CoreMetadata, Hashes, ProjectStatus, PypiFile, Status, Yanked};
use fv_pypi_types::{HashError, LenientVersionSpecifiers};
...
pub enum Error {
    ...
    Pep440(#[source] fv_pep440::VersionSpecifiersParseError),
}
