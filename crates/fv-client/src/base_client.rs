...
use fv_auth::{AuthMiddleware, Credentials, CredentialsCache, Indexes, PyxTokenStore};
use fv_configuration::ProxyUrlKind;
use fv_configuration::{KeyringProviderType, ProxyUrl, TrustedHost};
...
use fv_redacted::DisplaySafeUrlError;
...
pub struct BaseClientBuilder<'a> {
    ...
    /// Global authentication cache for a fv invocation to share credentials across fv clients.
    ...
    /// fv subcommand in which this client is being used
...
impl<'a> BaseClientBuilder<'a> {
    ...
    fn create_secure_and_insecure_clients(
        ...
        let user_agent_string = format!("fv/{}", version());
