...
pub enum ErrorKind {
    ...
    Metadata(String, #[source] fv_metadata::Error),
    ...
    MetadataParseError(
        WheelFilename,
        String,
        #[source] Box<fv_pypi_types::MetadataError>,
    ),
...
impl WrappedReqwestError {
    ...
    /// and from fv's outer retry loop for streaming bodies. Stripping the inner count from the
