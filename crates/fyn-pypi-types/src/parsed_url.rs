...
use fyn_distribution_filename::{DistExtension, ExtensionError};
use fyn_git_types::{GitUrl, GitUrlParseError};
use fyn_pep508::{
...
impl TryFrom<DisplaySafeUrl> for ParsedGitUrl {
    ...
    /// excluded, it's presumed to come from `tool.fyn.sources`.
