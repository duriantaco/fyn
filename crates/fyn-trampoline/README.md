...
```shell
cp target/aarch64-pc-windows-msvc/release/fyn-trampoline-console.exe ../fyn-trampoline-builder/trampolines/fyn-trampoline-aarch64-console.exe
cp target/aarch64-pc-windows-msvc/release/fyn-trampoline-gui.exe ../fyn-trampoline-builder/trampolines/fyn-trampoline-aarch64-gui.exe
cp target/x86_64-pc-windows-msvc/release/fyn-trampoline-console.exe ../fyn-trampoline-builder/trampolines/fyn-trampoline-x86_64-console.exe
cp target/x86_64-pc-windows-msvc/release/fyn-trampoline-gui.exe ../fyn-trampoline-builder/trampolines/fyn-trampoline-x86_64-gui.exe
cp target/i686-pc-windows-msvc/release/fyn-trampoline-console.exe ../fyn-trampoline-builder/trampolines/fyn-trampoline-i686-console.exe
cp target/i686-pc-windows-msvc/release/fyn-trampoline-gui.exe ../fyn-trampoline-builder/trampolines/fyn-trampoline-i686-gui.exe
```
