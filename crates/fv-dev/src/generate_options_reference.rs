...
use fv_options_metadata::{OptionField, OptionSet, OptionsMetadata, Visit};
use fv_settings::Options as SettingsOptions;
use fv_workspace::pyproject::ToolFv as WorkspaceOptions;
...
// `description` in fv.schema.json, see https://github.com/SchemaStore/schemastore/blob/master/editor-features.md#title-as-an-expected-object-type
/// Metadata and configuration for fv.
...
fn emit_field(output: &mut String, name: &str, field: &OptionField, parents: &[Set]) {
    ...
    match parents[0] {
        ...
        Set::Global {
            ...
            // For uv_toml_only options, only show the fv.toml tab
...
fn format_header(
    ...
    let tool_parent = match configuration {
        ConfigurationFile::PyprojectToml => Some("tool.fv"),
