//! Generate the environment variables reference from `fv_static::EnvVars`.
...
fn generate() -> String {
    ...
    output.push_str("fv defines and respects the following environment variables:\n\n");
    ...
    output.push_str("fv also reads the following externally defined environment variables:\n\n");
