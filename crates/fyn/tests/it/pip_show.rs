...
fn show_requires_multiple() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.pip_show()
        .arg("requests"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn show_python_version_marker() -> Result<()> {
    ...
    fyn_snapshot!(filters, context.pip_show()
        .arg("click"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn show_files() {
    ...
    #[cfg(not(windows))]
    fyn_snapshot!(context.filters(), context.pip_show().arg("requests").arg("--files"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    Name: requests
...
fn show_target() -> Result<()> {
    ...
    fyn_snapshot!(context.pip_show().arg("markupsafe"), @"
    success: false
    exit_code: 1
    ----- stdout -----
