...
fn list_outdated_columns() -> Result<()> {
    ...
    fyn_snapshot!(context.pip_list().arg("--outdated"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn list_outdated_json() -> Result<()> {
    ...
    fyn_snapshot!(context.pip_list().arg("--outdated").arg("--format").arg("json"), @r#"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn list_outdated_freeze() {
    ...
    fyn_snapshot!(context.pip_list().arg("--outdated").arg("--format").arg("freeze"), @"
    success: false
    exit_code: 2
    ----- stdout -----
...
fn list_editable() {
    ...
    fyn_snapshot!(filters, context.pip_list(), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn list_editable_only() {
    ...
    Usage: fyn pip list --cache-dir [CACHE_DIR] --editable --exclude-newer <EXCLUDE_NEWER>
...
fn list_target() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.pip_list()
        .arg("--target")
        .arg(target.path()), @"
    success: true
    exit_code: 0
