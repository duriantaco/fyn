...
fn format_project() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.format(), @"
    success: true
    exit_code: 0
    ----- stdout -----
    1 file reformatted
    ...
    ----- stderr -----
    warning: `fyn format` is experimental and may change without warning. Pass `--preview-features format` to disable this warning.
    ");
...
fn format_from_project_root() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.format().current_dir(&subdir), @"
    success: true
    exit_code: 0
    ----- stdout -----
    1 file reformatted
...
fn format_no_project() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.format().arg("--no-project"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    1 file reformatted
...
fn format_relative_project() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.format().arg("--project").arg("project"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    1 file reformatted
...
fn format_check() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.format().arg("--check"), @"
    success: false
    exit_code: 1
    ----- stdout -----
...
fn format_diff() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.format().arg("--diff"), @"
    success: false
    exit_code: 1
    ----- stdout -----
    --- main.py
...
fn format_with_ruff_args() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.format().arg("--").arg("main.py").arg("--line-length").arg("200"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn format_specific_files() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.format().arg("--").arg("main.py"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    1 file reformatted
...
fn format_version_option() -> Result<()> {
    ...
    // format command :)
    fyn_snapshot!(context.filters(), context.format().arg("--version").arg("0.8.2"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    1 file reformatted
...
fn format_version_constraints() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.format().arg("--version").arg(">=0.8.0").arg("--show-version"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    1 file reformatted
...
fn format_version_latest() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.format().arg("--version").arg("latest").arg("--show-version"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    1 file reformatted
...
fn format_exclude_newer() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.format().arg("--exclude-newer").arg("2026-01-01").arg("--version").arg("latest").arg("--show-version"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    1 file reformatted
...
fn format_no_matching_version() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.format().arg("--version").arg(">=999.0.0"), @"
    success: false
    exit_code: 2
    ----- stdout -----
