...
#[test]
fn status_check_in_managed_project() -> Result<()> {
    let context = fyn_test::test_context!("3.12");
    context
        .temp_dir
        .child("pyproject.toml")
...
#[test]
fn status_check_in_unmanaged_directory() {
    let context = fyn_test::test_context!("3.12");
...
#[test]
fn status_check_missing_lock() -> Result<()> {
    let context = fyn_test::test_context!("3.12");
    context
        .temp_dir
        .child("pyproject.toml")
...
#[test]
fn status_json_check_in_unmanaged_directory() {
    let context = fyn_test::test_context!("3.12");
