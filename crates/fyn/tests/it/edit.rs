...
mod conditional_imports {
    pub(crate) use fyn_test::{READ_ONLY_GITHUB_TOKEN, decode_token};
}
...
use fyn_cache_key::{RepositoryUrl, cache_digest};
use fyn_fs::Simplified;
use fyn_static::EnvVars;

use fyn_test::{fyn_snapshot, packse_index_url, venv_bin_path};
...
fn add_registry() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("anyio==3.7.0"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_git() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("uv-public-pypackage @ git+https://github.com/astral-test/uv-public-pypackage@0.0.1"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.add().arg("uv-public-pypackage @ git+https://github.com/astral-test/uv-public-pypackage").arg("--tag=0.0.1"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_git_private_source() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg(format!("uv-private-pypackage @ git+https://{token}@github.com/astral-test/uv-private-pypackage")), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_git_private_raw() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg(format!("uv-private-pypackage @ git+https://{token}@github.com/astral-test/uv-private-pypackage")).arg("--raw-sources"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
async fn add_git_private_rate_limited_by_github_rest_api_429_response() -> Result<()> {
    use fyn_client::DEFAULT_RETRIES;
...
fn add_git_error() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("flask").arg("--tag").arg("0.0.1"), @"
    success: false
    exit_code: 2
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.add().arg("flask @ https://files.pythonhosted.org/packages/61/80/ffe1da13ad9300f87c93af113edd0638c75138c42a0994becfacac078c06/flask-3.0.3-py3-none-any.whl").arg("--branch").arg("0.0.1"), @"
    success: false
    exit_code: 2
    ----- stdout -----
...
fn add_git_branch() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("uv-public-pypackage @ git+https://github.com/astral-test/uv-public-pypackage").arg("--branch").arg("test-branch"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_git_lfs() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add()
        .arg("--no-cache")
    ...
    // They help handle slightly different output in fyn-distribution/src/source/mod.rs between
...
fn add_git_raw() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("uv-public-pypackage @ git+https://github.com/astral-test/uv-public-pypackage@0.0.1").arg("--raw-sources"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_git_implicit() -> Result<()> {
    ...
    // Omit the `git+` prefix.
    fyn_snapshot!(context.filters(), context.add().arg("uv-public-pypackage @ https://github.com/astral-test/uv-public-pypackage.git"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_raw_error() -> Result<()> {
    ...
    // Provide a tag without a Git source.
    fyn_snapshot!(context.filters(), context.add().arg("uv-public-pypackage @ git+https://github.com/astral-test/uv-public-pypackage").arg("--tag").arg("0.0.1").arg("--raw-sources"), @"
    success: false
    exit_code: 2
    ----- stdout -----
    ...
    Usage: fyn add --cache-dir [CACHE_DIR] --tag <TAG> --exclude-newer <EXCLUDE_NEWER> <PACKAGES|--requirements <REQUIREMENTS>>
...
fn reinstall_local_source_trees() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().current_dir(&project_1).arg("../project2").arg("--editable"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // Running `fyn add` should reinstall the project.
    fyn_snapshot!(context.filters(), context.add().current_dir(&project_1).arg("../project2").arg("--editable"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_editable_error() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("flask @ https://files.pythonhosted.org/packages/61/80/ffe1da13ad9300f87c93af113edd0638c75138c42a0994becfacac078c06/flask-3.0.3-py3-none-any.whl").arg("--editable"), @"
    success: false
    exit_code: 2
    ----- stdout -----
...
fn add_unnamed() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("git+https://github.com/astral-test/uv-public-pypackage").arg("--tag=0.0.1"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_remove_dev() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("anyio==3.7.0").arg("--dev"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // `fyn add` implies a full lock and sync, including development dependencies.
    let lock = context.read("fyn.lock");
    ...
    fyn_snapshot!(context.filters(), context.remove().arg("anyio"), @"
    success: false
    exit_code: 2
    ----- stdout -----

    ----- stderr -----
    hint: `anyio` is in the `dev` group (try: `fyn remove anyio --group dev`)
    error: The dependency `anyio` could not be found in `project.dependencies`
    ");

    // Remove the dependency.
    fyn_snapshot!(context.filters(), context.remove().arg("anyio").arg("--dev"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_remove_optional() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("anyio==3.7.0").arg("--optional=io"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    ----- stderr -----
    hint: `anyio` is an optional dependency (try: `fyn remove anyio --optional io`)
    error: The dependency `anyio` could not be found in `project.dependencies`
    ");

    // Remove the dependency.
    fyn_snapshot!(context.filters(), context.remove().arg("anyio").arg("--optional=io"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_remove_inline_optional() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("typing-extensions").arg("--optional=types"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.remove().arg("typing-extensions").arg("--optional=types"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_remove_workspace() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), add_cmd, @"
    success: false
    exit_code: 2
    ----- stdout -----
    ...
    // Install from the lockfile.
    fyn_snapshot!(context.filters(), context.sync().arg("--frozen").current_dir(&child1), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // Remove the dependency.
    fyn_snapshot!(context.filters(), context.remove().arg("child2").current_dir(&child1), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
/// `fyn add --dev` should update `dev-dependencies` (rather than `dependency-groups.dev`) if a
...
/// `fyn add --dev` should add to `dev-dependencies` (rather than `dependency-groups.dev`) if it
/// exists.
#[test]
...
/// `fyn add --group dev` should update `dev-dependencies` (rather than `dependency-groups.dev`) if a
...
fn update_existing_dev_group() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("anyio==3.7.0").arg("--group").arg("dev"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
/// `fyn add --group dev` should add to `dependency-groups` even if `dev-dependencies` exists.
#[test]
...
/// `fyn remove --dev` should remove from both `dev-dependencies` and `dependency-groups.dev`.
#[test]
...
fn disallow_group_script_add() -> Result<()> {
    ...
    Usage: fyn add --cache-dir [CACHE_DIR] --group <GROUP> --exclude-newer <EXCLUDE_NEWER> <PACKAGES|--requirements <REQUIREMENTS>>
...
/// `fyn remove --group dev` should remove from both `dev-dependencies` and `dependency-groups.dev`.
#[test]
fn remove_both_dev_group() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.remove().arg("anyio").arg("--group").arg("dev"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_workspace_path() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("./child"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_path_implicit_workspace() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg(Path::new("packages").join("child")).current_dir(workspace.path()), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // `fyn add` implies a full lock and sync, including development dependencies.
    let lock = fs_err::read_to_string(workspace.join("fyn.lock"))?;
    ...
    // Install from the lockfile.
    fyn_snapshot!(context.filters(), context.sync().arg("--frozen").current_dir(workspace.path()), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_path_no_workspace() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg(Path::new("packages").join("child")).current_dir(workspace.path()).arg("--no-workspace"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_path_adjacent_directory() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg(dependency.path()).current_dir(project.path()), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // `fyn add` implies a full lock and sync, including development dependencies.
    let lock = fs_err::read_to_string(project.join("fyn.lock"))?;
...
/// Check relative and absolute path handling with `fyn add`.
///
/// TODO(tk): Currently `fyn add` always relativizes paths in `pyproject.toml`,
/// this is a bug.
#[test]
fn add_relative_and_absolute_paths() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("../relative_dep").current_dir(project.path()), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.add().arg(absolute_dep.path()).current_dir(project.path()), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.add().arg(file_url.as_str()).current_dir(project.path()), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn update() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("requests[security]"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.add().arg("requests; python_version > '3.7'").args(["--extra=use_chardet_on_py3", "--extra=socks"]), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // preserved).
    fyn_snapshot!(context.filters(), context.add().arg("requests @ git+https://github.com/psf/requests").arg("--tag=v2.32.3"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_update_marker() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("requests>=2.0,<2.29; python_version < '3.11'"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.add().arg("requests>=2.0,<2.20; python_version < '3.11'"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.add().arg("requests>=2.31 ; sys_platform == 'win32' and python_version > '3.11'"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.add().arg("requests>=2.10 ; sys_platform == 'win32'"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // Remove `requests`
    fyn_snapshot!(context.filters(), context.remove().arg("requests"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn update_source_replace_url() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("requests @ git+https://github.com/psf/requests").arg("--tag=v2.32.2"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
/// If a source defined in `tool.fyn.sources` but its name is not normalized, `fyn add` should not
...
fn add_update_git_reference_project() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("https://github.com/astral-test/uv-public-pypackage.git"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.add().arg("uv-public-pypackage").arg("--tag=0.0.1"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.add().arg("uv-public-pypackage").arg("--branch=main"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.add().arg("uv-public-pypackage").arg("--rev=2005223fcad0e2c06daf2e14b93b790604868e1e"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_update_git_reference_script() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("--script=script.py").arg("https://github.com/astral-test/uv-public-pypackage.git"),
        @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.add().arg("--script=script.py").arg("uv-public-pypackage").arg("--branch=test-branch"),
        @"
    success: true
    exit_code: 0
    ----- stdout -----
...
/// If a source defined in `tool.fyn.sources` but its name is not normalized, `fyn remove` should
/// remove the source.
#[test]
#[cfg(feature = "test-git")]
fn remove_non_normalized_source() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.remove().arg("uv-public-pypackage"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_inexact() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("iniconfig==2.0.0"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.sync().arg("--frozen").arg("--inexact"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_preserves_indentation_in_pyproject_toml() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("requests==2.31.0"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_frozen() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("anyio==3.7.0").arg("--frozen"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    assert!(!context.temp_dir.join("fyn.lock").exists());
...
fn add_no_sync() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("anyio==3.7.0").arg("--no-sync"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_reject_multiple_git_ref_flags() {
    ...
    Usage: fyn add [OPTIONS] <PACKAGES|--requirements <REQUIREMENTS>>
...
fn add_error() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("xyz"), @"
    success: false
    exit_code: 1
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.add().arg("xyz").arg("--frozen"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    let lock = context.temp_dir.join("fyn.lock");
    assert!(!lock.exists());
...
fn add_environment_yml_error() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("-r").arg("environment.yml"), @"
    success: false
    exit_code: 2
    ----- stdout -----
...
fn add_lower_bound() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("anyio"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_lower_bound_raw() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("anyio").arg("--raw"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_lower_bound_dev() -> Result<()> {
    ...
    // Adding `anyio` should include a lower-bound.
    fyn_snapshot!(context.filters(), context.add().arg("anyio").arg("--dev"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_lower_bound_optional() -> Result<()> {
    ...
    // Adding `anyio` should include a lower-bound.
    fyn_snapshot!(context.filters(), context.add().arg("anyio").arg("--optional=io"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_lower_bound_local() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("local-simple-a").arg("--index").arg(packse_index_url()).env_remove(EnvVars::UV_EXCLUDE_NEWER), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_non_project() -> Result<()> {
    ...
    // dependencies.
    fyn_snapshot!(context.filters(), context.add().arg("iniconfig"), @"
    success: false
    exit_code: 2
    ----- stdout -----

    ----- stderr -----
    error: Project is missing a `[project]` table; add a `[project]` table to use production dependencies, or run `fyn add --dev` instead
    ");

    // Adding `iniconfig` as optional should fail, since virtual workspace roots don't support
    // optional dependencies.
    fyn_snapshot!(context.filters(), context.add().arg("iniconfig").arg("--optional").arg("async"), @"
    success: false
    exit_code: 2
    ----- stdout -----

    ----- stderr -----
    error: Project is missing a `[project]` table; add a `[project]` table to use optional dependencies, or run `fyn add --dev` instead
    ");

    // Adding `iniconfig` as a dev dependency should succeed.
    fyn_snapshot!(context.filters(), context.add().arg("iniconfig").arg("--dev"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_virtual_empty() -> Result<()> {
    // testing how `fyn add` reacts to a pyproject with no `[project]` and nothing useful to it
    let context = fyn_test::test_context!("3.12");
...
fn add_virtual_dependency_group() -> Result<()> {
    // testing basic `fyn add --group` functionality
...
fn add_empty_requirements_group() -> Result<()> {
    // Test that `fyn add -r requirements.txt --group <name>` creates an empty group
...
fn add_empty_requirements_optional() -> Result<()> {
    // Test that `fyn add -r requirements.txt --optional <extra>` creates an empty extra
    // when the requirements file is empty
    let context = fyn_test::test_context!("3.12");
...
fn remove_virtual_empty() -> Result<()> {
    // testing how `fyn remove` reacts to a pyproject with no `[project]` and nothing useful to it
    let context = fyn_test::test_context!("3.12");
    ...
    fyn_snapshot!(context.filters(), context.remove()
        .arg("sortedcontainers"), @"
    success: false
    exit_code: 2
    ----- stdout -----
    ...
    ----- stderr -----
    error: The dependency `sortedcontainers` could not be found in `tool.fyn.dev-dependencies` or `tool.fyn.dependency-groups.dev`
    ");
...
fn remove_virtual_dependency_group() -> Result<()> {
    // testing basic `fyn remove --group` functionality
    // when the pyproject.toml is fully virtual (no `[project]`)
    let context = fyn_test::test_context!("3.12");
...
fn add_requirements_file() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("-r").arg("requirements.txt"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.add().arg("-r").arg("-").stdin(std::fs::File::open(requirements_txt)?), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.add().arg("-r").arg("setup.py"), @"
    success: false
    exit_code: 2
    ----- stdout -----

    ----- stderr -----
    error: Adding requirements from a `setup.py` is not supported in `fyn add`
    ");
    ...
    Usage: fyn add --cache-dir [CACHE_DIR] --exclude-newer <EXCLUDE_NEWER> <PACKAGES|--requirements <REQUIREMENTS>>
...
fn add_requirements_file_non_editable() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("-r").arg("requirements.txt").arg("--no-workspace"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_requirements_file_editable_override() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("-r").arg("requirements.txt").arg("--no-workspace").arg("--no-editable"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_requirements_file_with_marker_flag() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("-r").arg("requirements.win.txt").arg("-m").arg("python_version == '3.11'"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // Reset the project.
    pyproject_toml.write_str(base_pyproject_toml)?;
    fs_err::remove_file(context.temp_dir.join("fyn.lock"))?;

    // Add dependencies with a marker that applies for the current target.
    fyn_snapshot!(context.filters(), context.add().arg("-r").arg("requirements.win.txt").arg("-m").arg("python_version == '3.12'"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_requirements_file_constraints() -> Result<()> {
    ...
    requirements_txt.write_str(indoc! {r"
            ...
            #    fyn pip compile --cache-dir [CACHE_DIR] requirements.in -o requirements.txt
            anyio==3.7.1
    ...
    fyn_snapshot!(context.filters(), context.add().arg("-r").arg("requirements.in").arg("-c").arg("requirements.txt"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_group() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("anyio==3.7.0").arg("--group").arg("test"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.add().arg("requests").arg("--group").arg("test"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.add().arg("anyio==3.7.0").arg("--group").arg("second"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.add().arg("anyio==3.7.0").arg("--group").arg("alpha"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_group_normalize() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("iniconfig").arg("--group").arg("cloud_export_to_parquet"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.add().arg("typing-extensions").arg("--group").arg("cloud-export-to-parquet"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.remove().arg("iniconfig").arg("--group").arg("cloud_export_to_parquet"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.remove().arg("typing-extensions").arg("--group").arg("cloud-export-to-parquet"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_group_between_commented_groups() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("anyio==3.7.0").arg("--group").arg("eta"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn remove_group() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.remove().arg("anyio").arg("--group").arg("test"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_script() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("anyio").arg("--script").arg("script.py"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_script_bounds() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("anyio").arg("--bounds").arg("minor").arg("--script").arg("script.py"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_script_relative_path() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("./project").arg("--editable").arg("--script").arg("script.py"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_script_settings() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("anyio>=3").arg("--script").arg("script.py"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_script_without_metadata_table() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().args(["rich", "requests<3"]).arg("--script").arg("script.py"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_extensionless_script() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().args(["rich", "requests<3"]).arg("--script").arg("script"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
async fn add_requirements_from_remote_script() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("-r").arg(&script_url), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn remove_repeated() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.remove().arg("anyio").arg("--optional").arg("foo"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_remove_script_lock() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.remove().arg("anyio").arg("--script").arg("script.py"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn remove_last_dep_script() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.remove().arg("rich").arg("--script").arg("script.py"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_include_default_groups() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("typing-extensions"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn remove_include_default_groups() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.remove().arg("typing-extensions"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
/// Revert changes to the `pyproject.toml` and `fyn.lock` when the `add` operation fails.
#[test]
fn fail_to_add_revert_project() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("./child").arg("--no-workspace"), @r#"
    success: false
    exit_code: 1
    ----- stdout -----
...
fn fail_to_edit_revert_project() -> Result<()> {
    ...
    let before = fs_err::read_to_string(context.temp_dir.join("fyn.lock"))?;
    ...
    let after = fs_err::read_to_string(context.temp_dir.join("fyn.lock"))?;
    assert_eq!(before, after);

    Ok(())
}

/// Revert changes to the root `pyproject.toml` and `fyn.lock` when the `add` operation fails.
#[test]
fn fail_to_add_revert_workspace_root() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("./broken"), @r#"
    success: false
    exit_code: 1
    ----- stdout -----
...
fn fail_to_add_revert_workspace_member() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().current_dir(&project).arg("../broken"), @r#"
    success: false
    exit_code: 1
    ----- stdout -----
...
fn sorted_dependencies() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().args(["typing-extensions", "anyio"]), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn naive_sorted_dependencies() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().args(["pytest-randomly"]), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn sorted_dependencies_name_specifiers() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), universal_windows_filters=true, context.add().args(["pytest-mock"]), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), universal_windows_filters=true, context.add().args(["pytest-randomly"]), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn sorted_dependencies_with_include_group() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().args(["--dev", "pytest-randomly"]), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn sorted_dependencies_new_dependency_after_include_group() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().args(["--dev", "pytest"]), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn custom_dependencies() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("pydantic").arg("--frozen"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn update_offset() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().args(["typing-extensions", "iniconfig"]), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_shadowed_name() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("dagster-webserver==1.6.13"), @"
    success: false
    exit_code: 1
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.add().arg("dagster-webserver>=1.6.11,<1.7.0"), @"
    success: false
    exit_code: 1
    ----- stdout -----
...
fn add_warn_index_url() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("idna").arg("--index-url").arg("https://pypi.org/simple"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.add().arg("iniconfig").arg("--extra-index-url").arg("https://test.pypi.org/simple"), @"
    success: false
    exit_code: 1
    ----- stdout -----
...
fn add_index() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("iniconfig==2.0.0").arg("--index").arg("https://pypi.org/simple"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.add().arg("jinja2").arg("--index").arg("pytorch=https://astral-sh.github.io/pytorch-mirror/whl/cu121"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.add().arg("jinja2").arg("--index").arg("pytorch=https://test.pypi.org/simple"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.add().arg("typing-extensions").arg("--index").arg("https://pypi.org/simple"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.add().arg("typing-extensions").arg("--index").arg("https://test.pypi.org/simple"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_default_index_url() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("iniconfig").arg("--default-index").arg("https://test.pypi.org/simple"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.add().arg("typing-extensions").arg("--default-index").arg("https://pypi.org/simple"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
async fn add_index_credentials() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("iniconfig==2.0.0").env(EnvVars::UV_DEFAULT_INDEX, proxy.authenticated_url("public", "heron", "/basic-auth/simple")), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_index_with_existing_relative_path_index() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("iniconfig").arg("--index").arg("./test-index"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_index_with_ambiguous_relative_path() -> Result<()> {
    ...
    #[cfg(windows)]
    fyn_snapshot!(context.filters(), context.add().arg("iniconfig").arg("--index").arg("test-index"), @r"
    success: false
    exit_code: 2
    ----- stdout -----
...
fn add_group_comment() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("--group").arg("dev").arg("sniffio"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_index_comments() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("iniconfig==2.0.0").env(EnvVars::UV_DEFAULT_INDEX, "https://pypi.org/simple"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_self() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("anyio[types]").arg("--optional").arg("all"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.add().arg("anyio[types]").arg("--dev"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_direct_url_subdirectory() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("root @ https://github.com/user-attachments/files/18216295/subdirectory-test.tar.gz#subdirectory=packages/root"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_direct_url_subdirectory_raw() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("root @ https://github.com/user-attachments/files/18216295/subdirectory-test.tar.gz#subdirectory=packages/root").arg("--raw-sources"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_preserves_first_own_line_comment() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("charset-normalizer"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
/// Accept requirements, not just package names, in `fyn remove`.
#[test]
fn remove_requirement() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.remove().arg("flask[dotenv]"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn remove_all_with_comments() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.remove().arg("duct").arg("minilog"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_with_build_constraints() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("requests==1.2"), @"
    success: false
    exit_code: 1
    ----- stdout -----
...
fn add_unsupported_git_scheme() {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("git+fantasy://ferris/dreams/of/urls@7701ffcbae245819b828dc5f885a5201158897ef"), @"
    success: false
    exit_code: 2
    ----- stdout -----
...
async fn add_index_url_in_keyring() -> Result<()> {
    let keyring_context = fyn_test::test_context!("3.12");
...
/// If fyn receives an authentication failure from a configured index, it
...
/// fyn should continue searching the default index if it receives an
...
/// fyn should only fall through on 404s if an empty list is specified
...
/// fyn should not report a credential error on a missing package for pytorch since
...
fn add_missing_package_on_pytorch() -> Result<()> {
    ...
    fyn_snapshot!(context.add().arg("fakepkg"), @"
    success: false
    exit_code: 1
    ----- stdout -----
...
async fn add_unexpected_error_code() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("anyio").arg("--index").arg(server.uri())
        .env(EnvVars::UV_TEST_NO_HTTP_RETRY_DELAY, "true")
...
/// fyn should fail to parse `pyproject.toml` if `ignore-error-codes`
...
/// fyn should fail to parse `pyproject.toml` if `require-python`
...
fn add_invalid_requires_python() -> Result<()> {
    ...
    fyn_snapshot!(context.add().arg("anyio"), @r#"
    success: false
    exit_code: 2
    ----- stdout -----
...
fn add_auth_policy_always_without_credentials() -> Result<()> {
    ...
    fyn_snapshot!(context.add().arg("anyio"), @"
    success: false
    exit_code: 2
    ----- stdout -----
    ...
    fyn_snapshot!(context.pip_install().arg("black"), @"
    success: false
    exit_code: 2
    ----- stdout -----
...
/// If fyn receives a 302 redirect to a cross-origin server, it should not forward
...
async fn add_redirect_cross_origin() -> Result<()> {
    ...
    fyn_snapshot!(filters, context.add().arg("--default-index").arg(redirect_url.as_str()).arg("anyio"), @"
    success: false
    exit_code: 1
    ----- stdout -----
...
/// If fyn receives a 302 redirect to a cross-origin server with credentials
...
/// fyn currently fails to look up keyring credentials on a cross-origin redirect.
#[tokio::test]
async fn add_redirect_with_keyring_cross_origin() -> Result<()> {
    ...
    fyn_snapshot!(filters, context.add().arg("--default-index")
...
/// If fyn receives a cross-origin 302 redirect, it should use credentials from netrc
...
async fn pip_install_redirect_with_netrc_cross_origin() -> Result<()> {
    ...
    fyn_snapshot!(filters, context.pip_install()
        .arg("anyio")
        .arg("--index-url")
        .arg(redirect_url.as_str())
...
fn add_ambiguous() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("--group").arg("bar").arg("anyio"), @"
    success: false
    exit_code: 2
    ----- stdout -----
...
fn add_optional_normalize() -> Result<()> {
    ...
    // Add with a non-normalized group name.
    fyn_snapshot!(context.filters(), context.add().arg("iniconfig").arg("--optional").arg("cloud_export_to_parquet"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // Add with a normalized group name (which doesn't match the `pyproject.toml`).
    fyn_snapshot!(context.filters(), context.add().arg("typing-extensions").arg("--optional").arg("cloud-export-to-parquet"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // Remove with a non-normalized group name.
    fyn_snapshot!(context.filters(), context.remove().arg("iniconfig").arg("--optional").arg("cloud_export_to_parquet"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // Remove with a normalized group name (which doesn't match the `pyproject.toml`).
    fyn_snapshot!(context.filters(), context.remove().arg("typing-extensions").arg("--optional").arg("cloud-export-to-parquet"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
/// Test `fyn add` with different kinds of bounds and constraints.
#[test]
fn add_bounds() -> Result<()> {
    let context = fyn_test::test_context!("3.12");

    // Set bounds in `fyn.toml`
    ...
    fyn_snapshot!(context.filters(), context.add().arg("idna"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.add().arg("anyio").arg("--bounds").arg("minor"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.add().arg("anyio==4.2").arg("idna").arg("--bounds").arg("minor"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.add().arg("sniffio").arg("--bounds").arg("minor"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
/// contain a workspace definition, so `fyn add` should create one.
#[test]
...
fn add_no_install_project() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("iniconfig").arg("--no-install-project"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn add_git_lfs_error() -> Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.add().arg("typing-extensions").arg("--lfs"), @"
    success: false
    exit_code: 2
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.add().arg("typing-extensions").env(EnvVars::UV_GIT_LFS, "true"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.add().arg("typing-extensions").env(EnvVars::UV_GIT_LFS, "true").arg("--lfs"), @"
    success: false
    exit_code: 2
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.add().arg("typing-extensions").env(EnvVars::UV_GIT_LFS, "false").arg("--lfs"), @"
    success: false
    exit_code: 2
    ----- stdout -----
...
/// Ensure that `fyn add` aborts when malware is detected in a dependency.
#[tokio::test]
