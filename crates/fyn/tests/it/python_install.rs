...
use fyn_test::{LATEST_PYTHON_3_12, fyn_snapshot};
use indoc::indoc;
use predicates::prelude::predicate;
use tracing::debug;

use fyn_fs::Simplified;
use fyn_python::managed::platform_key_from_env;
...
fn python_install() {
    ...
    fyn_snapshot!(context.filters(), context.python_install(), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), Command::new(bin_python.as_os_str())
    ...
    ----- stderr -----
    Python is already installed. Use `fyn python install <request>` to install another version.
    ");

    // Similarly, when a requested version is already installed
    fyn_snapshot!(context.filters(), context.python_install().arg("3.14"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("3.14").arg("--reinstall"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_uninstall(), @"
    success: false
    exit_code: 2
    ----- stdout -----
    ...
    Usage: fyn python uninstall --cache-dir [CACHE_DIR] --install-dir <INSTALL_DIR> <TARGETS>...

    For more information, try '--help'.
    ");

    fyn_snapshot!(context.filters(), context.python_uninstall().arg("3.14"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn python_reinstall() {
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("3.12").arg("3.13"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("3.13").arg("--reinstall"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("--reinstall"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("3.11").arg("--reinstall"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn python_reinstall_patch() {
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("3.12.6").arg("3.12.7"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("3.12").arg("--reinstall"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn python_install_force() {
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("--force"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    warning: Failed to install executable for cpython-3.14.[LATEST]-[PLATFORM]
      Caused by: Executable already exists at `[BIN]/python3.14` but is not managed by fyn; use `--force` to replace it
    ");

    fyn_snapshot!(context.filters(), context.python_install().arg("--force").arg("3.14"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn python_install_minor() {
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("3.11"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_uninstall().arg("3.11"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn python_install_multiple_patch() {
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("3.12.8").arg("3.12.6"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_uninstall().arg("3.12.8"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn python_install_preview() {
    ...
    // Install the latest version
    fyn_snapshot!(context.filters(), context.python_install().arg("--preview"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // You can opt-in to a reinstall
    fyn_snapshot!(context.filters(), context.python_install().arg("--preview").arg("--reinstall"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("--preview").arg("--force"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("--preview").arg("3.14"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("--preview").arg("--bin").arg("3.14"), @"
    success: false
    exit_code: 1
    ----- stdout -----
    ...
    error: Failed to install executable for cpython-3.14.[LATEST]-[PLATFORM]
      Caused by: Executable already exists at `[BIN]/python3.14` but is not managed by fyn; use `--force` to replace it
    ");
    fyn_snapshot!(context.filters(), context.python_install().arg("--preview").arg("3.14").env(EnvVars::UV_PYTHON_INSTALL_BIN, "1"), @"
    success: false
    exit_code: 1
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("--preview").arg("--no-bin").arg("3.14"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    Python 3.14 is already installed
    ");
    fyn_snapshot!(context.filters(), context.python_install().arg("--preview").arg("3.14").env(EnvVars::UV_PYTHON_INSTALL_BIN, "0"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("--preview").arg("--force").arg("3.14"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // Install a minor version
    fyn_snapshot!(context.filters(), context.python_install().arg("3.11").arg("--preview"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // Install multiple patch versions
    fyn_snapshot!(context.filters(), context.python_install().arg("--preview").arg("3.12.8").arg("3.12.6"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn python_install_preview_no_bin() {
    ...
    // Install the latest version
    fyn_snapshot!(context.filters(), context.python_install().arg("--preview").arg("--no-bin"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("--preview").arg("--no-bin").arg("--default"), @"
    success: false
    exit_code: 2
    ----- stdout -----
    ...
    Usage: fyn python install --cache-dir [CACHE_DIR] --no-bin --install-dir <INSTALL_DIR> [TARGETS]...
...
fn python_install_preview_upgrade() {
    ...
    // Install 3.12.5
    fyn_snapshot!(context.filters(), context.python_install().arg("--preview").arg("3.12.5"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("--preview").arg("3.12.4"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("--preview").arg("3.12.4").arg("--reinstall"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // But `--force` is
    fyn_snapshot!(context.filters(), context.python_install().arg("--preview").arg("3.12.4").arg("--force"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("--preview").arg("3.12.6"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn python_install_freethreaded() {
    ...
    // Install the latest version
    fyn_snapshot!(context.filters(), context.python_install().arg("--preview").arg("3.13t"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_find().arg("3.13t"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_find().arg("3.13+freethreaded"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    [TEMP_DIR]/managed/cpython-3.13+freethreaded-[PLATFORM]/[INSTALL-BIN]/[PYTHON]
    ...
    fyn_snapshot!(context.filters(), context.venv().arg("--python").arg("3.13t"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("3.13"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("3.12t"), @"
    success: false
    exit_code: 2
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_uninstall().arg("--all"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn python_upgrade_not_allowed() {
    ...
    fyn_snapshot!(context.filters(), context.python_upgrade().arg("--preview").arg("3.13.0"), @"
    success: false
    exit_code: 1
    ----- stdout -----

    ----- stderr -----
    error: `fyn python upgrade` only accepts minor versions, got: 3.13.0
    ");

    // Request a pre-release upgrade
    fyn_snapshot!(context.filters(), context.python_upgrade().arg("--preview").arg("3.14rc3"), @"
    success: false
    exit_code: 1
    ----- stdout -----

    ----- stderr -----
    error: `fyn python upgrade` only accepts minor versions, got: 3.14rc3
    ");
}
...
fn python_install_debug() {
    ...
    // Install the latest version
    fyn_snapshot!(context.filters(), context.python_install().arg("--preview").arg("3.13+debug"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // We should find it with opt-in
    fyn_snapshot!(context.filters(), context.python_find().arg("3.13d"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_find().arg("3.13"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    [TEMP_DIR]/managed/cpython-3.13+debug-[PLATFORM]/bin/python3.13d
    ...
    fyn_snapshot!(context.filters(), context.python_find().arg("3.13+debug"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    [TEMP_DIR]/managed/cpython-3.13+debug-[PLATFORM]/bin/python3.13d
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("3.12d"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn python_install_debug_freethreaded() {
    ...
    // Install the latest version
    fyn_snapshot!(context.filters(), context.python_install().arg("--preview").arg("3.13td"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // We should find it with opt-in
    fyn_snapshot!(context.filters(), context.python_find().arg("3.13td"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_find().arg("3.13+freethreaded+debug"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    [TEMP_DIR]/managed/cpython-3.13+freethreaded+debug-[PLATFORM]/bin/python3.13td
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("3.13t"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("3.13d"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn python_install_invalid_request() {
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("foobar"), @"
    success: false
    exit_code: 2
    ----- stdout -----

    ----- stderr -----
    error: `foobar` is not a valid Python download request; see `fyn help python` for supported formats and `fyn python list --only-downloads` for available versions
    ");

    // Request a version we don't have a download for
    fyn_snapshot!(context.filters(), context.python_install().arg("3.8.0"), @"
    success: false
    exit_code: 2
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("3.8.0").arg("3.12"), @"
    success: false
    exit_code: 2
    ----- stdout -----
...
fn python_install_default() {
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("--default").arg("3.14"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("--default"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("3.12").arg("3.14").arg("--default"), @"
    success: false
    exit_code: 2
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("3.12").arg("--default"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn python_install_default_preview() {
    ...
    // Install again, with `--default`
    fyn_snapshot!(context.filters(), context.python_install().arg("--preview").arg("--default").arg("3.14"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // Install the latest version, i.e., a "default install"
    fyn_snapshot!(context.filters(), context.python_install().arg("--default").arg("--preview"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // Install multiple versions, with the `--default` flag
    fyn_snapshot!(context.filters(), context.python_install().arg("--preview").arg("3.12").arg("3.14").arg("--default"), @"
    success: false
    exit_code: 2
    ----- stdout -----
    ...
    // Install 3.12 as a new default
    fyn_snapshot!(context.filters(), context.python_install().arg("--preview").arg("3.12").arg("--default"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("--preview").arg("3.14").arg("--default"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn launcher_path(path: &Path) -> PathBuf {
    let launcher = fyn_trampoline_builder::Launcher::try_from_path(path)
...
fn python_install_unknown() {
    ...
    // A directory
    fyn_snapshot!(context.filters(), context.python_install().arg("./foo"), @"
    success: false
    exit_code: 2
    ----- stdout -----

    ----- stderr -----
    error: `./foo` is not a valid Python download request; see `fyn help python` for supported formats and `fyn python list --only-downloads` for available versions
    ");
}
...
fn python_install_default_from_env() {
    ...
    fyn_snapshot!(context.filters(), context.python_install().env(EnvVars::UV_PYTHON, "3.12"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("3.11").env(EnvVars::UV_PYTHON, "3.12"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_uninstall().env(EnvVars::UV_PYTHON, "3.12"), @"
    success: false
    exit_code: 2
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_uninstall().arg("--all").env(EnvVars::UV_PYTHON, "3.11"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_uninstall().arg("--all").arg("3.12"), @"
    success: false
    exit_code: 2
    ----- stdout -----
    ...
    Usage: fyn python uninstall --cache-dir [CACHE_DIR] --all --install-dir <INSTALL_DIR> <TARGETS>...
...
fn python_install_patch_dylib() {
    ...
    fyn_snapshot!(context.filters(), cmd, @r###"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn python_install_prerelease() {
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("3.15"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("3.15.0a2"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn python_find_prerelease() {
    ...
    // installed
    fyn_snapshot!(context.filters(), context.python_find().arg("3.15"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_find().arg("3"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    [TEMP_DIR]/managed/cpython-3.15-[PLATFORM]/[INSTALL-BIN]/[PYTHON]
...
fn python_install_emulated_macos() {
    ...
    // Before installation, `fyn python list` should not show the x86_64 download
    fyn_snapshot!(context.filters(), context.python_list().arg("3.13"), @r"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("3.13-x86_64"), @r"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // It should be discoverable with `fyn python find`
    fyn_snapshot!(context.filters(), context.python_find().arg("3.13").arg("--resolve-links"), @r"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // And included in `fyn python list`
    fyn_snapshot!(context.filters(), context.python_list().arg("3.13"), @r"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("3.13-aarch64"), @r"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn python_install_emulated_windows_x86_on_x64() {
    ...
    // Before installation, `fyn python list` should not show the x86_32 download
    fyn_snapshot!(context.filters(), context.python_list().arg("3.13"), @r"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("3.13-x86"), @r"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // It should be discoverable with `fyn python find`
    fyn_snapshot!(context.filters(), context.python_find().arg("3.13"), @r"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn install_managed_venv_allow_existing() {
    ...
    fyn_snapshot!(context.filters(), context.venv().arg("-p").arg("3.13")
...
fn install_transparent_patch_upgrade_uv_venv() {
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("--preview").arg("3.12.9"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.venv().arg("-p").arg("3.12")
        .arg(context.venv.as_os_str()), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("--preview").arg("3.12.11"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // Install a lower patch version.
    fyn_snapshot!(context.filters(), context.python_install().arg("--preview").arg("3.12.8"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn install_multiple_patches() {
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("--preview").arg("3.12.9").arg("3.12.11"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("--preview").arg("3.10.17").arg("3.10.16"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.venv().arg("-p").arg("3.10")
        .arg(context.venv.as_os_str()), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn uninstall_highest_patch() {
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("--preview").arg("3.12.11").arg("3.12.9").arg("3.12.8"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_uninstall().arg("--preview").arg("3.12.11"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
// Virtual environments only record minor versions. `fyn venv -p 3.x.y` will
...
fn install_no_transparent_upgrade_with_venv_patch_specification() {
    ...
    fyn_snapshot!(context.filters(), context.venv().arg("-p").arg("3.12.9")
        .arg(context.venv.as_os_str()), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn install_transparent_patch_upgrade_venv_module() {
    ...
    fyn_snapshot!(context.filters(), context.run().arg("python").arg("-m").arg("venv").arg(context.venv.as_os_str()).arg("--without-pip")
...
// `fyn run` should not downgrade virtual environments.
#[test]
fn install_lower_patch_automatically() {
    ...
    fyn_snapshot!(context.filters(), context.init().arg("-p").arg("3.12.9").arg("proj"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn uninstall_last_patch() {
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("--preview").arg("3.10.17"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_uninstall().arg("--preview").arg("3.10.17"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    hint: Consider recreating the environment (e.g., with `fyn venv`)
    "
    );
...
fn python_install_pyodide() {
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("cpython-3.13.2-emscripten-wasm32-musl"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_find().arg("cpython-3.13.2-emscripten-wasm32-musl"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.venv().arg("--python").arg("cpython-3.13.2-emscripten-wasm32-musl"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_command().arg("-c").arg("import subprocess; print('hello world')"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    hello world
    ...
    // Install via `pyodide`
    fyn_snapshot!(context.filters(), context.python_install().arg("pyodide"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("pyodide@3.13"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // Find via `pyodide``
    fyn_snapshot!(context.filters(), context.python_find().arg("pyodide"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    [TEMP_DIR]/managed/pyodide-3.13.2-emscripten-wasm32-musl/python
    ...
    fyn_snapshot!(context.filters(), context.python_find(), @"
    success: false
    exit_code: 2
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_find().arg("cpython"), @"
    success: false
    exit_code: 2
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("cpython"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_find().arg("any"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn python_install_upgrade() {
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("--upgrade"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    ----- stderr -----
    The default Python installation is already on the latest supported patch release. Use `fyn python install <request>` to install another version.
    ");

    // Install an earlier patch version
    fyn_snapshot!(context.filters(), context.python_install().arg("3.10.17"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // Ask for an `--upgrade`
    fyn_snapshot!(context.filters(), context.python_install().arg("--upgrade").arg("3.10"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("--upgrade").arg("3.11.4"), @"
    success: false
    exit_code: 1
    ----- stdout -----

    ----- stderr -----
    error: `fyn python install --upgrade` only accepts minor versions, got: 3.11.4
    ");

    // Request a version that isn't installed yet
    fyn_snapshot!(context.filters(), context.python_install().arg("--upgrade").arg("3.11"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("3.9.5"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("--upgrade").arg("3.10").arg("3.11"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("--upgrade").arg("3.9").arg("3.10").arg("3.11").arg("3.12"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn python_install_upgrade_version_file() {
    ...
    ----- stderr -----
    error: `fyn python install --upgrade` only accepts minor versions, got: 3.12.4
...
fn python_install_armv7() {
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("cpython-3.12.12-linux-armv7-musl"), @"
    success: false
    exit_code: 2
    ----- stdout -----

    ----- stderr -----
    error: fyn does not yet provide musl Python distributions on armv7.
    ");

    // Explicitly request a gnuabi build for armv7l
    fyn_snapshot!(context.filters(), context.python_install().arg("cpython-3.12.12-linux-armv7-gnueabi"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn python_install_compile_bytecode() -> anyhow::Result<()> {
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("--compile-bytecode").arg("3.14"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("--reinstall").arg("--compile-bytecode").arg("3.14"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn python_install_compile_bytecode_upgrade() {
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("3.14.0"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("--upgrade").arg("--compile-bytecode").arg("3.14"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn python_install_upgrade_build_version() {
    ...
    // Install Python 3.12
    fyn_snapshot!(context.filters(), context.python_install().arg("3.12"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("--upgrade").arg("3.12"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn python_install_compile_bytecode_multiple() {
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("--compile-bytecode").arg("3.14").arg("3.12"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn python_install_compile_bytecode_pyodide() {
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("--compile-bytecode").arg("cpython-3.13.2-emscripten-wasm32-musl"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    //fyn_snapshot!(context.filters(), context.python_upgrade().arg("--compile-bytecode"), @r"TODO");
}
...
fn python_install_compile_bytecode_graalpy() {
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("--compile-bytecode").arg("graalpy-3.12"), @"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn python_install_compile_bytecode_pypy() {
    ...
    fyn_snapshot!(context.filters(), context.python_install().arg("--compile-bytecode").arg("pypy-3.11"), @"
    success: true
    exit_code: 0
    ----- stdout -----
