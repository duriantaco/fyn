...
fn freeze_duplicate() -> Result<()> {
    ...
    // Run `pip freeze`.
    fyn_snapshot!(context1.filters(), context1.pip_freeze().arg("--strict"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    pip==21.3.1
...
fn freeze_multiple_paths() -> Result<()> {
    ...
    // Run `pip freeze`.
    fyn_snapshot!(context.filters(), context.pip_freeze().arg("--path").arg(target1.path()).arg("--path").arg(target2.path()), @"
    success: true
    exit_code: 0
    ----- stdout -----
    markupsafe==2.1.3
...
fn freeze_with_quiet_flag() -> Result<()> {
    ...
    fyn_snapshot!(context.pip_freeze().arg("--quiet"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    markupsafe==2.1.3
...
fn freeze_exclude() {
    ...
    fyn_snapshot!(context.filters(), context.pip_freeze().arg("--exclude").arg("MarkupSafe").arg("--prefix").arg(prefix.path()), @"
    success: true
    exit_code: 0
    ----- stdout -----
    tomli==2.0.1
    ...
    fyn_snapshot!(context.filters(), context.pip_freeze().arg("--exclude").arg("MarkupSafe").arg("--exclude").arg("tomli").arg("--prefix").arg(prefix.path()), @"
    success: true
    exit_code: 0
    ----- stdout -----
