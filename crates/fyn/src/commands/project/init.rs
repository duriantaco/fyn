...
use fyn_scripts::{Pep723Script, ScriptTag};
...
use fyn_workspace::{DiscoveryOptions, MemberDiscovery, Workspace, WorkspaceCache, WorkspaceError};
...
fn pyproject_build_system(package: &PackageName, build_backend: ProjectBuildBackend) -> String {
    ...
    match build_backend {
        ProjectBuildBackend::Uv => {
            ...
            let min_version = Version::from_str(fyn_version::version()).unwrap();
            debug_assert!(
