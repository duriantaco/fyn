...
use fyn_python::PythonInstallationKey;
...
impl From<fyn_python::downloads::Direction> for Direction {
    fn from(dir: fyn_python::downloads::Direction) -> Self {
        match dir {
            fyn_python::downloads::Direction::Download => Self::Download,
            fyn_python::downloads::Direction::Extract => Self::Extract,
        }
    }
}
...
impl fyn_installer::PrepareReporter for PrepareReporter {
...
impl fyn_resolver::ResolverReporter for ResolverReporter {
...
impl fyn_distribution::Reporter for ResolverReporter {
    fn on_build_start(&self, source: &BuildableSource) -> usize {
        self.reporter.on_build_start(source)
    }
...
impl fyn_installer::InstallReporter for InstallReporter {
...
impl fyn_python::downloads::Reporter for PythonDownloadReporter {
    fn on_request_start(
        &self,
        direction: fyn_python::downloads::Direction,
    ...
    fn on_request_complete(&self, direction: fyn_python::downloads::Direction, id: usize) {
...
impl fyn_publish::Reporter for PublishReporter {
...
impl fyn_cache::CleanReporter for CleaningDirectoryReporter {
    fn on_clean(&self) {
        self.bar.inc(1);
    }
...
impl fyn_bin_install::Reporter for BinaryDownloadReporter {
