...
/// The style of a fyn logging line.
pub struct UvFormat {
...
/// Return the field formatter for fyn logging.
///
/// The event formatter is responsible for fyn's own log colors, such as the level prefix. Field
...
pub fn fyn_fields() -> impl for<'writer> FormatFields<'writer> {
...
fn format_field(writer: &mut Writer<'_>, field: &Field, value: &dyn fmt::Debug) -> fmt::Result {
    // Match tracing-subscriber's default field formatting.
