...
use fv_configuration::HashCheckingMode;
...
use fv_pypi_types::{HashDigest, HashDigests, HashError, ResolverMarkerEnvironment};
    ...
    fn pin(requirement: &Requirement) -> Option<VersionId> {
        match &requirement.source {
            RequirementSource::Registry { specifier, .. } => {
                ...
                if *specifier.operator() != fv_pep440::Operator::Equal {
                    return None;
                }
