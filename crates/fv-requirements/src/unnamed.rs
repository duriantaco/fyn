...
use fv_distribution::{DistributionDatabase, Reporter};
use fv_distribution_filename::{DistExtension, SourceDistFilename, WheelFilename};
...
use fv_pep508::{UnnamedRequirement, VersionOrUrl};
use fv_pypi_types::{Metadata10, ParsedUrl, PyProjectToml, VerbatimParsedUrl};
use fv_resolver::{InMemoryIndex, MetadataResponse};
...
impl<'a, Context: BuildContext> NamedRequirementsResolver<'a, Context> {
    ...
    async fn resolve_requirement(
        ...
        index: &InMemoryIndex,
        database: &DistributionDatabase<'a, Context>,
    ) -> Result<fv_pep508::Requirement<VerbatimParsedUrl>, Error> {
            ...
            .is_some_and(|ext| ext.eq_ignore_ascii_case("whl"))
        {
            ...
            return Ok(fv_pep508::Requirement {
                name: filename.name,
