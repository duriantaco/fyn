...
use fv_client::{BaseClientBuilder, Connectivity};
use fv_configuration::{NoBinary, NoBuild, PackageNameSpecifier};
use fv_distribution_types::{
    Requirement, UnresolvedRequirement, UnresolvedRequirementSpecification,
};
use fv_fs::Simplified;
use fv_pep508::{Pep508Error, RequirementOrigin, VerbatimUrl, expand_env_vars};
...
pub struct RequirementsTxt {
    ...
    pub constraints: Vec<fv_pep508::Requirement<VerbatimParsedUrl>>,
    /// Editables with `-e`.
...
impl RequirementsTxt {
    ...
    async fn parse_impl(
        ...
        } else if requirements_txt.starts_with("http://") | requirements_txt.starts_with("https://")
        {
            ...
            let content = fv_fs::read_to_string_transcode(&requirements_txt)
                .await
                .map_err(|err| RequirementsTxtFileError {
                    file: requirements_txt.to_path_buf(),
...
pub enum RequirementsTxtParserError {
    Io(io::Error),
    Url {
        source: fv_pep508::VerbatimUrlError,
        url: String,
        start: usize,
        end: usize,
    },
    ...
    NoBinary {
        source: fv_normalize::InvalidNameError,
        specifier: String,
        start: usize,
        end: usize,
    },
