...
use fyn_distribution_types::{CompatibleDist, DistributionId, Identifier, ResolvedDist};
...
pub(crate) struct FilePins(FxHashMap<(PackageName, fyn_pep440::Version), FilePin>);
