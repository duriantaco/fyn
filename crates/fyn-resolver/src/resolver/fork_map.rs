...
use fyn_distribution_types::{Requirement, RequirementSource};
use fyn_normalize::PackageName;
use fyn_pep508::{MarkerTree, RequirementOrigin};
use fyn_pypi_types::{ConflictItem, ConflictItemRef, ConflictKind};
...
mod tests {
    ...
    use fyn_distribution_types::RequirementSource;
