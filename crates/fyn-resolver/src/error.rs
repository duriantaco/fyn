...
use fyn_pep440::{LocalVersionSlice, LowerBound, Version};
...
pub enum ResolveError {
    ...
    #[error(transparent)]
    Distribution(#[from] fyn_distribution::Error),
    ...
    #[error(transparent)]
    DistributionType(#[from] fyn_distribution_types::Error),
    ...
    Dist(
        ...
        Box<RequestedDist>,
        DerivationChain,
        #[source] Arc<fyn_distribution::Error>,
    ),
    ...
    InvalidVersion(#[from] fyn_pep440::VersionSpecifierBuildError),
