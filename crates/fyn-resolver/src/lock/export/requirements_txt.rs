...
use fyn_distribution_filename::{DistExtension, SourceDistExtension};
use fyn_fs::Simplified;
use fyn_git_types::GitReference;
use fyn_normalize::PackageName;
use fyn_pypi_types::{ParsedArchiveUrl, ParsedGitUrl};
        ...
        } in &self.nodes
        {
            match &package.id.source {
                ...
                Source::Git(url, git) => {
                    ...
                    let git_url = fyn_git_types::GitUrl::from_commit(
                        url,
