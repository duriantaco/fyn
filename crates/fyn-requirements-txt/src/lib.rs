...
use fyn_redacted::DisplaySafeUrlError;
...
pub struct RequirementsTxt {
    ...
    pub constraints: Vec<fyn_pep508::Requirement<VerbatimParsedUrl>>,
    /// Editables with `-e`.
...
impl RequirementsTxt {
    ...
    async fn parse_impl(
        ...
        } else if requirements_txt.starts_with("http://") | requirements_txt.starts_with("https://")
        {
            ...
            let content = fyn_fs::read_to_string_transcode(&requirements_txt)
                .await
                .map_err(|err| RequirementsTxtFileError {
                    file: requirements_txt.to_path_buf(),
...
pub enum RequirementsTxtParserError {
    Io(io::Error),
    Url {
        source: fyn_pep508::VerbatimUrlError,
        url: String,
        start: usize,
        end: usize,
    },
    ...
    NoBinary {
        source: fyn_normalize::InvalidNameError,
        specifier: String,
        start: usize,
        end: usize,
    },
