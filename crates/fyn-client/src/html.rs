...
use fyn_pypi_types::{BaseUrl, CoreMetadata, Hashes, ProjectStatus, PypiFile, Status, Yanked};
use fyn_pypi_types::{HashError, LenientVersionSpecifiers};
...
pub enum Error {
    ...
    Pep440(#[source] fyn_pep440::VersionSpecifiersParseError),
}
