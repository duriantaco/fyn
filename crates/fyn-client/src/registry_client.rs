...
use fyn_auth::{CredentialsCache, Indexes, PyxTokenStore};
use fyn_cache::{Cache, CacheBucket, CacheEntry, WheelCache};
use fyn_configuration::IndexStrategy;
...
impl SimpleDetailMetadata {
    ...
    fn from_pypi_files(
        files: Vec<fyn_pypi_types::PypiFile>,
        package_name: &PackageName,
        project_status: ProjectStatus,
        base: &Url,
    ) -> Self {
    ...
    fn from_pyx_files(
        files: Vec<fyn_pypi_types::PyxFile>,
        mut core_metadata: FxHashMap<Version, fyn_pypi_types::CoreMetadatum>,
        package_name: &PackageName,
        project_status: ProjectStatus,
        base: &Url,
    ) -> Self {
...
mod tests {
    ...
    use fyn_normalize::PackageName;
    use fyn_pypi_types::PypiSimpleDetail;
    use fyn_redacted::DisplaySafeUrl;
    use url::Url;
    ...
    use fyn_cache::Cache;
    use fyn_distribution_types::{FileLocation, ToUrlError};
    use fyn_small_str::SmallString;
