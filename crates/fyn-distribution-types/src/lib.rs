...
use fyn_fs::normalize_absolute_path;
use fyn_git_types::GitUrl;
use fyn_normalize::PackageName;
use fyn_pep440::Version;
use fyn_pep508::{Pep508Url, VerbatimUrl};
use fyn_pypi_types::{
...
impl Identifier for DisplaySafeUrl {
    fn distribution_id(&self) -> DistributionId {
        DistributionId::Url(fyn_cache_key::CanonicalUrl::new(self))
    }

    fn resource_id(&self) -> ResourceId {
        ResourceId::Url(fyn_cache_key::RepositoryUrl::new(self))
    }
}
