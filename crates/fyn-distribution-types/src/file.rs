...
use fyn_pep440::{VersionSpecifiers, VersionSpecifiersParseError};
use fyn_pep508::split_scheme;
use fyn_pypi_types::{CoreMetadata, HashDigests, Yanked};
use fyn_redacted::{DisplaySafeUrl, DisplaySafeUrlError};
use fyn_small_str::SmallString;

/// Error converting [`fyn_pypi_types::PypiFile`] to [`distribution_type::File`].
...
/// Internal analog to [`fyn_pypi_types::PypiFile`].
