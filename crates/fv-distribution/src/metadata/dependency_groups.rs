...
/// like `fv pip install --group` must also support it for interop and conformance.
///
...
///
/// However several fv extensions make this complicated, notably, as of this writing:
///
/// * tool.fv.sources
/// * tool.fv.index
///
