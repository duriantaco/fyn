...
use fv_workspace::pyproject::{ExtraBuildDependencies, ExtraBuildDependency, ToolFvSources};
use fv_workspace::{
...
impl BuildRequires {
    ...
    /// dependencies.
    pub fn from_metadata23(metadata: fv_pypi_types::BuildRequires) -> Self {
        Self {
            name: metadata.name,
    ...
    pub async fn from_project_maybe_workspace(
        metadata: fv_pypi_types::BuildRequires,
        install_path: &Path,
