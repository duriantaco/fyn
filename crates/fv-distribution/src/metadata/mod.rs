...
use fv_distribution_types::{GitSourceUrl, IndexLocations, Requirement};
use fv_normalize::{ExtraName, GroupName, PackageName};
use fv_pep440::{Version, VersionSpecifiers};
use fv_pypi_types::{HashDigests, ResolutionMetadata};
use fv_workspace::dependency_groups::DependencyGroupError;
use fv_workspace::{WorkspaceCache, WorkspaceError};
...
impl Metadata {
    ...
    pub async fn from_workspace(
        ...
        let requires_dist = fv_pypi_types::RequiresDist {
            name: metadata.name,
