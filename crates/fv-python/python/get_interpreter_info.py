...
# the start of a local segment which must be non-empty. Thus, `fv` chokes on it
...
def get_operating_system_and_architecture():
    ...
    This can differ from fv's architecture and operating system. For example, Apple
    ...
    if operating_system == "linux":
        ...
        # https://github.com/astral-sh/fv/issues/9842
        ...
        # https://github.com/astral-sh/fv/issues/2450
