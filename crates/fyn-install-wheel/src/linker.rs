...
use fyn_fs::link::{CopyLocks, LinkOptions, OnExistingDirectory, link_dir};
use fyn_preview::{Preview, PreviewFeature};
use fyn_warnings::warn_user;

use crate::Error;

pub use fyn_fs::link::LinkMode;
...
impl InstallState {
    ...
    /// Get the underlying copy locks for use with [`fyn_fs::link::link_dir`] functions.
