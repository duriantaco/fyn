...
use fyn_distribution_types::{GitSourceUrl, IndexLocations, Requirement};
use fyn_normalize::{ExtraName, GroupName, PackageName};
use fyn_pep440::{Version, VersionSpecifiers};
use fyn_pypi_types::{HashDigests, ResolutionMetadata};
use fyn_workspace::dependency_groups::DependencyGroupError;
use fyn_workspace::{WorkspaceCache, WorkspaceError};
...
impl Metadata {
    ...
    pub async fn from_workspace(
        ...
        let requires_dist = fyn_pypi_types::RequiresDist {
            name: metadata.name,
