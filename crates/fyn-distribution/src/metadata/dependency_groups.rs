...
/// like `fyn pip install --group` must also support it for interop and conformance.
///
...
///
/// However several fyn extensions make this complicated, notably, as of this writing:
///
/// * tool.fyn.sources
/// * tool.fyn.index
///
