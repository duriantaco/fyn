...
use fyn_workspace::pyproject::{ExtraBuildDependencies, ExtraBuildDependency, ToolfynSources};
use fyn_workspace::{
...
impl BuildRequires {
    ...
    /// dependencies.
    pub fn from_metadata23(metadata: fyn_pypi_types::BuildRequires) -> Self {
        Self {
            name: metadata.name,
    ...
    pub async fn from_project_maybe_workspace(
        metadata: fyn_pypi_types::BuildRequires,
        install_path: &Path,
