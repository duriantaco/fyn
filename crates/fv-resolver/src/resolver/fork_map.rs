...
use fv_distribution_types::{Requirement, RequirementSource};
use fv_normalize::PackageName;
use fv_pep508::{MarkerTree, RequirementOrigin};
use fv_pypi_types::{ConflictItem, ConflictItemRef, ConflictKind};
...
mod tests {
    ...
    use fv_distribution_types::RequirementSource;
