...
use fv_distribution_filename::{DistExtension, SourceDistExtension};
use fv_fs::Simplified;
use fv_git_types::GitReference;
use fv_normalize::PackageName;
use fv_pypi_types::{ParsedArchiveUrl, ParsedGitUrl};
        ...
        } in &self.nodes
        {
            match &package.id.source {
                ...
                Source::Git(url, git) => {
                    ...
                    let git_url = fv_git_types::GitUrl::from_commit(
                        url,
