...
use fv_normalize::{ExtraName, InvalidNameError, PackageName};
use fv_pep440::{LocalVersionSlice, LowerBound, Version};
...
pub enum ResolveError {
    ...
    #[error(transparent)]
    Distribution(#[from] fv_distribution::Error),
    ...
    #[error(transparent)]
    DistributionType(#[from] fv_distribution_types::Error),
    ...
    Dist(
        ...
        Box<RequestedDist>,
        DerivationChain,
        #[source] Arc<fv_distribution::Error>,
    ),
    ...
    InvalidVersion(#[from] fv_pep440::VersionSpecifierBuildError),
