...
use fv_distribution_types::{CompatibleDist, DistributionId, Identifier, ResolvedDist};
...
pub(crate) struct FilePins(FxHashMap<(PackageName, fv_pep440::Version), FilePin>);
