...
def _run() -> None:
    ...
    # Let `fyn` know that it was spawned by this Python interpreter
    ...
    if sys.platform == "win32":
        ...
        try:
            completed_process = subprocess.run([fyn, *sys.argv[1:]], env=env)
        except KeyboardInterrupt:
            sys.exit(2)

        sys.exit(completed_process.returncode)
    else:
        os.execvpe(fyn, [fyn, *sys.argv[1:]], env=env)
