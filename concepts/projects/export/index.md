...
[PEP 751](https://peps.python.org/pep-0751/) defines a TOML-based lockfile format for Python dependencies. fyn can export your project's dependency lockfile to this format.
...
The generated SBOM follows the [CycloneDX specification](https://cyclonedx.org/specification/overview/). fyn also includes the following custom properties on components:
...
To learn more about lockfiles and exporting, see the [locking and syncing](../sync/) documentation and the [command reference](../../../reference/cli/#fyn-export).
