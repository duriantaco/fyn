...
The minimum supported Rust version required to compile fyn is listed in the `rust-version` key of
...
This is only relevant to users who build fyn from source. Installing fyn from the Python package
