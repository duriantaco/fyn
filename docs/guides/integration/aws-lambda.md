---
title: Using fyn with AWS Lambda
description:
  A complete guide to using fyn with AWS Lambda to manage Python dependencies and deploy serverless
  functions via Docker containers or zip archives.
---

# Using fyn with AWS Lambda

[AWS Lambda](https://aws.amazon.com/lambda/) is a serverless computing service that lets you run
code without provisioning or managing servers.

You can use fyn with AWS Lambda to manage your Python dependencies, build your deployment package,
...
By default, `fyn init --lib` will create a package that exports a `hello` function. We'll modify the
