...
unavailable, fyn will download Python for you. See the
[Python version](../concepts/python-versions.md) documentation for more details.

## Using a virtual environment

When using the default virtual environment name, fyn will automatically find and use the virtual
...
fyn itself does not depend on Python, but it does need to locate a Python environment to (1) install
